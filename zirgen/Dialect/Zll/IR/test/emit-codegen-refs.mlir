...
func.func @ref_clone_test(%arg0 : !zll.val<BabyBear>, %arg1 : !emptyLayout, %arg2: !emptyStruct, %arg4 : !layoutWithEmpty,   %globbuf : !zll.buffer<4, global>) -> !structWithEmpty {
  ...
  // CHECK-SAME: (arg0: Val, arg1: BoundLayout<EmptyLayout, impl BufferRow<ValType = Val>>, arg2: &EmptyStruct, arg3: BoundLayout<WithEmptyLayout, impl BufferRow<ValType = Val>>, arg4: Global4Buf) -> Result<WithEmptyStruct>
