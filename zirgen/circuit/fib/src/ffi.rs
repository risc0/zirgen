...
extern "C" {
    ...
    pub(crate) fn risc0_circuit_fib_step_compute_accum(
        err: *mut RawError,
        ctx: *mut c_void,
        cb: Callback,
        steps: usize,
    ...
    pub(crate) fn risc0_circuit_fib_step_verify_accum(
        err: *mut RawError,
        ctx: *mut c_void,
        cb: Callback,
        steps: usize,
    ...
    pub(crate) fn risc0_circuit_fib_step_exec(
        err: *mut RawError,
        ctx: *mut c_void,
        cb: Callback,
        steps: usize,
    ...
    pub(crate) fn risc0_circuit_fib_step_verify_bytes(
        err: *mut RawError,
        ctx: *mut c_void,
        cb: Callback,
        steps: usize,
    ...
    pub(crate) fn risc0_circuit_fib_step_verify_mem(
        err: *mut RawError,
        ctx: *mut c_void,
        cb: Callback,
        steps: usize,
    ...
    pub(crate) fn risc0_circuit_fib_poly_fp(
        cycle: usize,
        steps: usize,
