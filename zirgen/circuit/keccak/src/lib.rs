...
mod keccak_circuit {
    ...
    type ExecContext<'a> = risc0_zirgen_dsl::cpu::CpuBuffers<'a, Val, &'a super::cpu::CpuExecContext<'a>>;
...
>(
    ...
    let mut prover = risc0_zkp::prove::Prover::new(hal, &*crate::keccak_circuit::TAPS);
    prover.set_po2(PO2);
