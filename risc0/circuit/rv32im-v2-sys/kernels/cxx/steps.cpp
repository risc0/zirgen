...
ValU32Struct exec_DynPo2(ExecContext& ctx, Val arg0, BoundLayout<DynPo2Layout> layout1) {
  ...
  ValU32Struct x27 = ValU32Struct{.low = x24._super._super, .high = x26._super._super};
  return x27;
}
NormalizeU32Struct exec_NormalizeU32(ExecContext& ctx,
  ...
  NormalizeU32Struct x10 =
      NormalizeU32Struct{._super = ValU32Struct{.low = x2._super, .high = x7._super}, .carry = x8};
  return x10;
}
...
AddrDecomposeBitsStruct exec_AddrDecomposeBits(ExecContext& ctx,
  ...
  return AddrDecomposeBitsStruct{._super = x14, .low0 = x3, .low1 = x5, .low2 = x6, .addr = x14};
}
  ...
  NondetRegStruct16Array x2 = map(
      ...
      ([&](Val16Array::value_type x3, BoundLayout<NondetRegLayout16LayoutArray::value_type> x4) {
        ...
        EQZ(((x5 * Val16Array{Val(1),
            ...
            "loc(callsite( Div ( <preamble> :17:22) at  ToBits ( "
            "zirgen/circuit/rv32im/v2/dsl/po2.zir :31:43)))");
        NondetRegStruct x6 = exec_NondetBitReg(ctx,
                                               (x5 * bitAnd(arg0,
                                                            Val16Array{Val(1),
                                                                       Val(2),
                                                                       Val(4),
...
GetDataStruct exec_MemoryGet(ExecContext& ctx,
  ...
  if (to_size_t(arg2._super[0]._super)) {
    ...
    GetDataStruct x6 =
        exec_MemoryPageIn(ctx, arg0, arg1, LAYOUT_LOOKUP(layout3, _super.arm1._super));
...
DecoderStruct exec_DecodeInst(ExecContext& ctx,
  ...
  CycleArgStruct x4 =
      exec_CycleArg(ctx, neg_0(x3), arg0._super._super, LAYOUT_LOOKUP(layout2, arg));
  ...
  AddrDecomposeStruct x6 =
      exec_AddrDecompose(ctx, arg1.pcU32, arg1.mode, LAYOUT_LOOKUP(layout2, pcAddr));
...
WriteRdStruct exec_WriteRd(ExecContext& ctx,
  ...
  MemoryWriteStruct x12 =
      exec_MemoryWrite(ctx, arg0, x11._super._super, arg4, LAYOUT_LOOKUP(layout5, _0));
...
ExpandU32Struct exec_ExpandU32(ExecContext& ctx,
  ...
  return ExpandU32Struct{.b0 = x3, .b1 = x5, .b2 = x6, .b3 = x8, .neg = (x12._super * arg1)};
}
SplitTotalStruct
...
MultiplyAccumulateStruct exec_MultiplyAccumulate(ExecContext& ctx,
  ...
  NondetRegStruct x49 =
      exec_NondetU16Reg(ctx, bitAnd(x48, Val(65535)), LAYOUT_LOOKUP(layout4, s3Out));
  // MultiplyAccumulate(zirgen/circuit/rv32im/v2/dsl/mult.zir:151)
  FakeTwitRegStruct x50 = exec_FakeTwitReg(
      ctx, ((x48 - x49._super) * Val(2013235201)), LAYOUT_LOOKUP(layout4, s3Carry));
  // ValU32(zirgen/circuit/rv32im/v2/dsl/u32.zir:10)
  // MultiplyAccumulate(zirgen/circuit/rv32im/v2/dsl/mult.zir:152)
  ValU32Struct x51 = ValU32Struct{.low = x16.out._super, .high = x27.out._super};
  // MultiplyAccumulate(zirgen/circuit/rv32im/v2/dsl/mult.zir:153)
  ValU32Struct x52 = ValU32Struct{.low = x41.out._super, .high = x49._super};
  return MultiplyAccumulateStruct{.outLow = x51, .outHigh = x52};
}
DivInputStruct exec_DivInput(ExecContext& ctx,
  ...
  return DivInputStruct{._super = arg1, .ii = arg1, .decoded = x3, .rs1 = x4, .rs2 = x5};
}
DivideReturnStruct exec_DoDiv(ExecContext& ctx,
                              ValU32Struct arg0,
                              ValU32Struct arg1,
                              Val arg2,
                              Val arg3,
  ...
  auto [x5, x6, x7, x8] = INVOKE_EXTERN(
      ctx, divide, arg0.low, arg0.high, arg1.low, arg1.high, (arg2 + (arg3 * Val(2))));
  ...
  ValU32Struct x14 = ValU32Struct{.low = x12._super, .high = x13._super};
...
exec_Div0(ExecContext& ctx, RegStruct arg0, InstInputStruct arg1, BoundLayout<Div0Layout> layout2) {
  ...
  WriteRdStruct x13 =
      exec_WriteRd(ctx, arg0, x3.ii, x3.decoded, Val(1), x4, LAYOUT_LOOKUP(layout2, _0));
  ...
  NormalizeU32Struct x15 =
      exec_NormalizeU32(ctx,
                        DenormedValU32Struct{.low = x14, .high = arg1.pcU32.high},
                        LAYOUT_LOOKUP(layout2, pcAdd));
  return InstOutputStruct{.newPc = x15._super, .newState = Val(32), .newMode = arg1.mode};
}
MiscInputStruct exec_MiscInput(ExecContext& ctx,
  ...
  GetDataStruct x5 = exec_ReadReg(ctx, arg0, arg1, x3.rs2, LAYOUT_LOOKUP(layout2, rs2));
  return MiscInputStruct{._super = arg1, .ii = arg1, .decoded = x3, .rs1 = x4, .rs2 = x5};
}
InstOutputStruct exec_FinalizeMisc(ExecContext& ctx,
  ...
  WriteRdStruct x6 = exec_WriteRd(
      ctx, arg0, arg1.ii, arg1.decoded, arg2.doWrite, x4._super, LAYOUT_LOOKUP(layout3, _0));
  // InstOutput(zirgen/circuit/rv32im/v2/dsl/inst.zir:46)
  // FinalizeMisc(zirgen/circuit/rv32im/v2/dsl/inst_misc.zir:25)
  InstOutputStruct x7 =
      InstOutputStruct{.newPc = x5._super, .newState = Val(32), .newMode = arg1.ii.mode};
  return x7;
}
MiscOutputStruct
...
exec_OpSLT(ExecContext& ctx, MiscInputStruct arg0, BoundLayout<OpSLTLayout> layout1) {
  ...
  DenormedValU32Struct x5 =
      DenormedValU32Struct{.low = x4.isLessThan._super._super, .high = Val(0)};
  // AddU32(zirgen/circuit/rv32im/v2/dsl/u32.zir:27)
  // SimpleOp(zirgen/circuit/rv32im/v2/dsl/inst_misc.zir:74)
...
InstOutputStruct exec_Misc0(ExecContext& ctx,
  ...
  // DenormedValU32(zirgen/circuit/rv32im/v2/dsl/u32.zir:20)
  DenormedValU32Struct x8 = DenormedValU32Struct{.low = x7, .high = x3._super.pcU32.high};
  // VerifyOpcodeF3F7(zirgen/circuit/rv32im/v2/dsl/inst.zir:64)
  ...
  MiscOutputStruct x12 =
      MiscOutputStruct{.doWrite = Val(1),
                       .toWrite = DenormedValU32Struct{.low = (x10 - x3.rs2._super.low),
                                                       .high = (x11 - x3.rs2._super.high)},
                       .newPc = x8};
  ...
  if (to_size_t(x3._super.minorOnehot._super[0]._super)) {
    ...
    x16 = MiscOutputStruct{
        .doWrite = Val(1), .toWrite = DenormedValU32Struct{.low = x5, .high = x6}, .newPc = x8};
  } else if (to_size_t(x3._super.minorOnehot._super[1]._super)) {
    // VerifyOpcodeF3F7(zirgen/circuit/rv32im/v2/dsl/inst.zir:62)
    // OpSUB(zirgen/circuit/rv32im/v2/dsl/inst_misc.zir:91)
    // Misc0(zirgen/circuit/rv32im/v2/dsl/inst_misc.zir:32)
    ...
    EQZ(LOAD(LAYOUT_LOOKUP(layout2, miscOutput.arm7._extra4.count._super), 0),
        "Misc0(zirgen/circuit/rv32im/v2/dsl/inst_misc.zir:30)");
    x16 = MiscOutputStruct{
        .doWrite = Val(1), .toWrite = DenormedValU32Struct{.low = x14, .high = x15}, .newPc = x8};
  } else {
    assert(0 && "Reached unreachable mux arm");
  }
...
InstOutputStruct exec_Misc2(ExecContext& ctx,
  ...
  // DenormedValU32(zirgen/circuit/rv32im/v2/dsl/u32.zir:20)
  DenormedValU32Struct x6 = DenormedValU32Struct{.low = x5, .high = x3._super.pcU32.high};
  ...
  DenormedValU32Struct x13 =
      DenormedValU32Struct{.low = x3.decoded.immU.low, .high = x3.decoded.immU.high};
  // VerifyOpcode(zirgen/circuit/rv32im/v2/dsl/inst.zir:53)
  ...
  DenormedValU32Struct x18 =
      DenormedValU32Struct{.low = x3._super.pcU32.low, .high = x3._super.pcU32.high};
  // MiscOutput(zirgen/circuit/rv32im/v2/dsl/inst_misc.zir:15)
  MiscOutputStruct x19 =
      MiscOutputStruct{.doWrite = Val(0),
                       .toWrite = DenormedValU32Struct{.low = Val(0), .high = Val(0)},
                       .newPc = x18};
  ...
  if (to_size_t(x3._super.minorOnehot._super[0]._super)) {
    ...
    x20 = MiscOutputStruct{
        .doWrite = Val(1), .toWrite = x6, .newPc = DenormedValU32Struct{.low = x7, .high = x8}};
  } else if (to_size_t(x3._super.minorOnehot._super[4]._super)) {
    // VerifyOpcodeF3(zirgen/circuit/rv32im/v2/dsl/inst.zir:57)
    // OpJALR(zirgen/circuit/rv32im/v2/dsl/inst_misc.zir:198)
    // Misc2(zirgen/circuit/rv32im/v2/dsl/inst_misc.zir:65)
    ...
    EQZ(LOAD(LAYOUT_LOOKUP(layout2, miscOutput.arm4._extra4.count._super), 0),
        "Misc2(zirgen/circuit/rv32im/v2/dsl/inst_misc.zir:60)");
    x20 = MiscOutputStruct{
        .doWrite = Val(1), .toWrite = x6, .newPc = DenormedValU32Struct{.low = x10, .high = x11}};
  } else if (to_size_t(x3._super.minorOnehot._super[5]._super)) {
    // VerifyOpcode(zirgen/circuit/rv32im/v2/dsl/inst.zir:53)
    // OpLUI(zirgen/circuit/rv32im/v2/dsl/inst_misc.zir:205)
    // Misc2(zirgen/circuit/rv32im/v2/dsl/inst_misc.zir:66)
    ...
    EQZ(LOAD(LAYOUT_LOOKUP(layout2, miscOutput.arm5._extra4.count._super), 0),
        "Misc2(zirgen/circuit/rv32im/v2/dsl/inst_misc.zir:60)");
    x20 = MiscOutputStruct{.doWrite = Val(1), .toWrite = x13, .newPc = x6};
  } else if (to_size_t(x3._super.minorOnehot._super[6]._super)) {
    // VerifyOpcode(zirgen/circuit/rv32im/v2/dsl/inst.zir:53)
    // OpAUIPC(zirgen/circuit/rv32im/v2/dsl/inst_misc.zir:210)
    // Misc2(zirgen/circuit/rv32im/v2/dsl/inst_misc.zir:67)
    ...
    EQZ(LOAD(LAYOUT_LOOKUP(layout2, miscOutput.arm6._extra4.count._super), 0),
        "Misc2(zirgen/circuit/rv32im/v2/dsl/inst_misc.zir:60)");
    x20 = MiscOutputStruct{
        .doWrite = Val(1), .toWrite = DenormedValU32Struct{.low = x15, .high = x16}, .newPc = x6};
  } else if (to_size_t(x3._super.minorOnehot._super[7]._super)) {
    // VerifyOpcodeF3F7(zirgen/circuit/rv32im/v2/dsl/inst.zir:62)
    // OpECALL(zirgen/circuit/rv32im/v2/dsl/inst_misc.zir:216)
    // Misc2(zirgen/circuit/rv32im/v2/dsl/inst_misc.zir:68)
...
MulInputStruct exec_MulInput(ExecContext& ctx,
  ...
  GetDataStruct x5 = exec_ReadReg(ctx, arg0, arg1, x3.rs2, LAYOUT_LOOKUP(layout2, rs2));
  return MulInputStruct{._super = arg1, .ii = arg1, .decoded = x3, .rs1 = x4, .rs2 = x5};
}
...
exec_Mul0(ExecContext& ctx, RegStruct arg0, InstInputStruct arg1, BoundLayout<Mul0Layout> layout2) {
  ...
  ValU32Struct x4 = ValU32Struct{.low = Val(0), .high = Val(0)};
  ValU32Struct x5;
  if (to_size_t(x3._super.minorOnehot._super[0]._super)) {
  ...
  WriteRdStruct x12 =
      exec_WriteRd(ctx, arg0, x3.ii, x3.decoded, Val(1), x5, LAYOUT_LOOKUP(layout2, _0));
  // AddU32(zirgen/circuit/rv32im/v2/dsl/u32.zir:27)
  // Mul0(zirgen/circuit/rv32im/v2/dsl/inst_mul.zir:34)
  Val x13 = (arg1.pcU32.low + Val(4));
  NormalizeU32Struct x14 =
      exec_NormalizeU32(ctx,
                        DenormedValU32Struct{.low = x13, .high = arg1.pcU32.high},
                        LAYOUT_LOOKUP(layout2, pcAdd));
  return InstOutputStruct{.newPc = x14._super, .newState = Val(32), .newMode = arg1.mode};
}
MemLoadInputStruct exec_MemLoadInput(ExecContext& ctx,
  ...
  AddrDecomposeBitsStruct x8 =
      exec_AddrDecomposeBits(ctx, x7._super, arg1.mode, LAYOUT_LOOKUP(layout2, addr));
  ...
  return MemLoadInputStruct{.ii = arg1, .decoded = x3, .addr = x8, .data = x9};
}
MemStoreInputStruct exec_MemStoreInput(ExecContext& ctx,
  ...
  AddrDecomposeBitsStruct x9 =
      exec_AddrDecomposeBits(ctx, x8._super, arg1.mode, LAYOUT_LOOKUP(layout2, addr));
...
MemStoreFinalizeStruct exec_MemStoreFinalize(ExecContext& ctx,
  ...
  MemoryWriteStruct x4 =
      exec_MemoryWrite(ctx, arg0, arg1.addr.addr, arg2, LAYOUT_LOOKUP(layout3, _0));
...
exec_Mem0(ExecContext& ctx, RegStruct arg0, InstInputStruct arg1, BoundLayout<Mem0Layout> layout2) {
  ...
  ValU32Struct x9 = ValU32Struct{.low = Val(0), .high = Val(0)};
  ValU32Struct x10;
  ...
  WriteRdStruct x14 =
      exec_WriteRd(ctx, arg0, x3.ii, x3.decoded, Val(1), x10, LAYOUT_LOOKUP(layout2, _0));
  // AddU32(zirgen/circuit/rv32im/v2/dsl/u32.zir:27)
  // Mem0(zirgen/circuit/rv32im/v2/dsl/inst_mem.zir:61)
  Val x15 = (arg1.pcU32.low + Val(4));
  NormalizeU32Struct x16 =
      exec_NormalizeU32(ctx,
                        DenormedValU32Struct{.low = x15, .high = arg1.pcU32.high},
                        LAYOUT_LOOKUP(layout2, pcAdd));
  return InstOutputStruct{.newPc = x16._super, .newState = Val(32), .newMode = arg1.mode};
}
ValU32Struct
...
exec_Mem1(ExecContext& ctx, RegStruct arg0, InstInputStruct arg1, BoundLayout<Mem1Layout> layout2) {
  ...
  ValU32Struct x9 = ValU32Struct{.low = (x6 + (x7 * x3.rs2._super.low)),
                                 .high = ((x7 * x3.data._super.high) + x8)};
  // VerifyOpcodeF3(zirgen/circuit/rv32im/v2/dsl/inst.zir:58)
  ...
  ValU32Struct x11 = ValU32Struct{.low = Val(0), .high = Val(0)};
  ValU32Struct x12;
  if (to_size_t(arg1.minorOnehot._super[0]._super)) {
  ...
  MemStoreFinalizeStruct x14 =
      exec_MemStoreFinalize(ctx, arg0, x3, x12, LAYOUT_LOOKUP(layout2, _0));
  // AddU32(zirgen/circuit/rv32im/v2/dsl/u32.zir:27)
...
InstOutputStruct exec_ControlResume(ExecContext& ctx,
  ...
  if (to_size_t(x6._super)) {
    ...
    GetDataStruct x9 = exec_MemoryRead(
    ...
    InstOutputStruct x10 =
        InstOutputStruct{.newPc = x8._super, .newState = Val(1), .newMode = x9._super.low};
    ...
    ControlResume_SuperArm1_Super__0Struct8Array x11 =
        map(Val8Array{Val(0), Val(1), Val(2), Val(3), Val(4), Val(5), Val(6), Val(7)},
            LAYOUT_LOOKUP(layout2, _super.arm1._1),
            ([&](Val8Array::value_type x12,
              ...
              ValU32Struct x15 =
                  ValU32Struct{.low = x14.values[to_size_t(x12)].low._super._super,
                               .high = x14.values[to_size_t(x12)].high._super._super};
              // ControlResume(zirgen/circuit/rv32im/v2/dsl/inst_control.zir:42)
              MemoryWriteStruct x16 =
                  exec_MemoryWrite(ctx, arg0, (x12 + Val(1073725592)), x15, LAYOUT_LOOKUP(x13, _0));
              return ControlResume_SuperArm1_Super__0Struct{};
            }));
    x7 = InstOutputStruct{.newPc = arg1.pcU32, .newState = Val(32), .newMode = arg1.mode};
  } else {
    assert(0 && "Reached unreachable mux arm");
  }
  return x7;
...
InstOutputStruct exec_ControlUserECALL(ExecContext& ctx,
  ...
  AddrDecomposeBitsStruct x4 =
      exec_AddrDecomposeBits(ctx, arg1.pcU32, x3._super._super, LAYOUT_LOOKUP(layout2, pcAddr));
  ...
  MemoryWriteStruct x12 =
      exec_MemoryWrite(ctx, arg0, Val(1073725568), arg1.pcU32, LAYOUT_LOOKUP(layout2, _1));
  return InstOutputStruct{.newPc = x11._super, .newState = Val(32), .newMode = Val(1)};
}
InstOutputStruct exec_ControlMRET(ExecContext& ctx,
  ...
  return InstOutputStruct{.newPc = x10._super, .newState = Val(32), .newMode = Val(0)};
}
InstOutputStruct exec_ControlSuspend(ExecContext& ctx,
  ...
  if (to_size_t(x6._super)) {
    ...
    GetDataStruct8Array x10 = map(
        ...
        ([&](Val8Array::value_type x11, BoundLayout<MemoryReadLayout8LayoutArray::value_type> x12) {
          GetDataStruct x13 = exec_MemoryRead(ctx, arg0, (x11 + Val(1073725584)), x12);
          return x13;
        }));
    ValU32Struct8Array x14 = ValU32Struct8Array{x10[0]._super,
                                                x10[1]._super,
                                                x10[2]._super,
                                                x10[3]._super,
                                                x10[4]._super,
    ...
    MemoryWriteStruct x29 = exec_MemoryWrite(
        ctx, arg0, Val(1073725572), arg1.pcU32, LAYOUT_LOOKUP(layout2, _super.arm1._super._0));
    // ControlSuspend(zirgen/circuit/rv32im/v2/dsl/inst_control.zir:114)
    MemoryWriteStruct x30 = exec_MemoryWrite(ctx,
                                             arg0,
                                             Val(1073725573),
                                             ValU32Struct{.low = arg1.mode, .high = Val(0)},
    ...
    EQZ(LOAD(LAYOUT_LOOKUP(layout2, _super.arm1._extra17.count._super), 0),
        "ControlSuspend(zirgen/circuit/rv32im/v2/dsl/inst_control.zir:84)");
    x9 = InstOutputStruct{.newPc = x8, .newState = Val(4), .newMode = arg1.mode};
  } else {
    assert(0 && "Reached unreachable mux arm");
  }
  return x9;
...
InstOutputStruct exec_ControlTable(ExecContext& ctx,
  ...
  Val16Array x7 = Val16Array{Val(0),
                             Val(1),
                             Val(2),
                             Val(3),
                             Val(4),
  ...
  ValU32Struct x10 = ValU32Struct{.low = x8, .high = Val(0)};
  InstOutputStruct x11;
  if (to_size_t(x4._super._super)) {
    // ControlTable(zirgen/circuit/rv32im/v2/dsl/inst_control.zir:137)
    ControlTable_SuperArm0_Super__0Struct16Array x12 =
        map(x7,
            LAYOUT_LOOKUP(layout2, _super.arm0._super._1),
            ([&](Val16Array::value_type x13,
    ...
    NondetRegStruct x19 =
        exec_IsZero(ctx, (x8 - Val(65536)), LAYOUT_LOOKUP(layout2, _super.arm0._super.done));
    InstOutputStruct x20;
    if (to_size_t(x19._super)) {
      x20 = InstOutputStruct{.newPc = x9, .newState = Val(7), .newMode = Val(0)};
    } else if (to_size_t((Val(1) - x19._super))) {
      x20 = InstOutputStruct{.newPc = x10, .newState = Val(6), .newMode = Val(1)};
    } else {
      assert(0 && "Reached unreachable mux arm");
    }
    // ControlTable(zirgen/circuit/rv32im/v2/dsl/inst_control.zir:135)
    ...
    ControlTable_SuperArm1_Super__0Struct16Array x21 =
        map(x7,
            LAYOUT_LOOKUP(layout2, _super.arm1._super._1),
            ([&](Val16Array::value_type x22,
    ...
    NondetRegStruct x28 =
        exec_IsZero(ctx, (x8 - Val(256)), LAYOUT_LOOKUP(layout2, _super.arm1._super.done));
    InstOutputStruct x29;
    if (to_size_t(x28._super)) {
      x29 = InstOutputStruct{.newPc = x9, .newState = Val(6), .newMode = Val(1)};
    } else if (to_size_t((Val(1) - x28._super))) {
      x29 = InstOutputStruct{.newPc = x10, .newState = Val(6), .newMode = Val(0)};
    } else {
      assert(0 && "Reached unreachable mux arm");
    }
    // ControlTable(zirgen/circuit/rv32im/v2/dsl/inst_control.zir:135)
...
InstOutputStruct exec_Control0(ExecContext& ctx,
  ...
  CycleArgStruct x5 =
      exec_CycleArg(ctx, neg_0(x4), arg0._super._super, LAYOUT_LOOKUP(layout2, arg));
  ...
  if (to_size_t(arg1.minorOnehot._super[0]._super)) {
    ...
    InstOutputStruct x9 =
        exec_ControlLoadRoot(ctx, arg0, arg1, LAYOUT_LOOKUP(layout2, _super.arm0._super), global3);
    ...
    InstOutputStruct x10 =
        exec_ControlResume(ctx, arg0, arg1, LAYOUT_LOOKUP(layout2, _super.arm1._super), global3);
    // Control0(zirgen/circuit/rv32im/v2/dsl/inst_control.zir:176)
    STORE(LAYOUT_LOOKUP(layout2, _super.arm1._extra0.count._super), Val(0));
    EQZ(LOAD(LAYOUT_LOOKUP(layout2, _super.arm1._extra0.count._super), 0),
        "Control0(zirgen/circuit/rv32im/v2/dsl/inst_control.zir:176)");
    ...
    InstOutputStruct x11 =
        exec_ControlUserECALL(ctx, arg0, arg1, LAYOUT_LOOKUP(layout2, _super.arm2._super));
    // Control0(zirgen/circuit/rv32im/v2/dsl/inst_control.zir:176)
    ...
    InstOutputStruct x12 =
        exec_ControlMRET(ctx, arg0, arg1, LAYOUT_LOOKUP(layout2, _super.arm3._super));
    // Control0(zirgen/circuit/rv32im/v2/dsl/inst_control.zir:176)
    ...
    InstOutputStruct x13 =
        exec_ControlSuspend(ctx, arg0, arg1, LAYOUT_LOOKUP(layout2, _super.arm4._super), global3);
    // Control0(zirgen/circuit/rv32im/v2/dsl/inst_control.zir:176)
    ...
    InstOutputStruct x14 =
        exec_ControlStoreRoot(ctx, arg0, arg1, LAYOUT_LOOKUP(layout2, _super.arm5._super), global3);
    // Control0(zirgen/circuit/rv32im/v2/dsl/inst_control.zir:176)
    ...
    InstOutputStruct x15 =
        exec_ControlTable(ctx, arg0, arg1, LAYOUT_LOOKUP(layout2, _super.arm6._super));
    // Control0(zirgen/circuit/rv32im/v2/dsl/inst_control.zir:176)
    ...
    EQZ(LOAD(LAYOUT_LOOKUP(layout2, _super.arm7._extra55.count._super), 0),
        "Control0(zirgen/circuit/rv32im/v2/dsl/inst_control.zir:176)");
    x8 = x7;
  } else {
    assert(0 && "Reached unreachable mux arm");
...
exec_DecomposeLow2(ExecContext& ctx, Val arg0, BoundLayout<DecomposeLow2Layout> layout1) {
  ...
  return DecomposeLow2Struct{.high = x2,
                             ...
                             .highZero = x5,
                             .isZero = x7,
                             .low2Nonzero = (x8 + x4._super[3]._super)};
}
ECallOutputStruct exec_ECallHostReadSetup(ExecContext& ctx,
  ...
  MemoryWriteStruct x10 = exec_MemoryWrite(ctx,
                                           arg0,
                                           Val(1073725450),
                                           ValU32Struct{.low = x7._super, .high = Val(0)},
                                           LAYOUT_LOOKUP(layout2, _0));
  // ECallHostReadSetup(zirgen/circuit/rv32im/v2/dsl/inst_ecall.zir:83)
  DecomposeLow2Struct x11 =
...
ECallOutputStruct exec_ECallHostReadWords(ExecContext& ctx,
  ...
  DecomposeLow2Struct x6 =
      exec_DecomposeLow2(ctx, x5.high._super, LAYOUT_LOOKUP(layout4, wordsDecomp));
  ...
  ECallHostReadWords__0Struct4Array x12 =
      map(Val4Array{Val(0), Val(1), Val(2), Val(3)},
          LAYOUT_LOOKUP(layout4, _1),
          ([&](Val4Array::value_type x13,
               BoundLayout<ECallHostReadWords__0_SuperLayout4LayoutArray::value_type> x14) {
            ...
            RegStruct x17 =
                exec_Reg(ctx, (x15 + (x16 * Val(1073725504))), LAYOUT_LOOKUP(x14, addr));
            // ECallHostReadWords(zirgen/circuit/rv32im/v2/dsl/inst_ecall.zir:139)
            MemoryWriteUnconstrainedStruct x18 =
                exec_MemoryWriteUnconstrained(ctx, arg0, x17._super._super, LAYOUT_LOOKUP(x14, _0));
  ...
  return ECallOutputStruct{.state = (x22 + ((x21 * (Val(1) - x5.low2Nonzero)) * Val(13))),
                           .s0 = (arg2 + x11),
                           .s1 = Val(0),
                           .s2 = x19};
}
InstOutputStruct exec_ECall0(ExecContext& ctx,
  ...
  AddrDecomposeBitsStruct x4 =
      exec_AddrDecomposeBits(ctx, arg1.pcU32, arg1.mode, LAYOUT_LOOKUP(layout2, pcAddr));
  ...
  if (to_size_t(arg1.minorOnehot._super[0]._super)) {
    ...
    ECallOutputStruct x7 =
        exec_MachineECall(ctx, arg0, arg1, x4._super, LAYOUT_LOOKUP(layout2, output.arm0._super));
    ...
    ECallOutputStruct x8 =
        exec_ECallTerminate(ctx, arg0, arg1, LAYOUT_LOOKUP(layout2, output.arm1._super), global3);
    // ECall0(zirgen/circuit/rv32im/v2/dsl/inst_ecall.zir:158)
    STORE(LAYOUT_LOOKUP(layout2, output.arm1._extra0.count._super), Val(0));
    EQZ(LOAD(LAYOUT_LOOKUP(layout2, output.arm1._extra0.count._super), 0),
        "ECall0(zirgen/circuit/rv32im/v2/dsl/inst_ecall.zir:158)");
    ...
    EQZ(LOAD(LAYOUT_LOOKUP(layout2, output.arm4._extra9.count._super), 0),
        "ECall0(zirgen/circuit/rv32im/v2/dsl/inst_ecall.zir:158)");
    STORE(LAYOUT_LOOKUP(layout2, output.arm4._extra10.count._super), Val(0));
    EQZ(LOAD(LAYOUT_LOOKUP(layout2, output.arm4._extra10.count._super), 0),
        "ECall0(zirgen/circuit/rv32im/v2/dsl/inst_ecall.zir:158)");
    STORE(LAYOUT_LOOKUP(layout2, output.arm4._extra11.count._super), Val(0));
    EQZ(LOAD(LAYOUT_LOOKUP(layout2, output.arm4._extra11.count._super), 0),
        "ECall0(zirgen/circuit/rv32im/v2/dsl/inst_ecall.zir:158)");
    STORE(LAYOUT_LOOKUP(layout2, output.arm4._extra12.count._super), Val(0));
    EQZ(LOAD(LAYOUT_LOOKUP(layout2, output.arm4._extra12.count._super), 0),
        "ECall0(zirgen/circuit/rv32im/v2/dsl/inst_ecall.zir:158)");
    STORE(LAYOUT_LOOKUP(layout2, output.arm4._extra13.count._super), Val(0));
    EQZ(LOAD(LAYOUT_LOOKUP(layout2, output.arm4._extra13.count._super), 0),
        "ECall0(zirgen/circuit/rv32im/v2/dsl/inst_ecall.zir:158)");
    x6 = ECallOutputStruct{.state = Val(16), .s0 = Val(0), .s1 = Val(0), .s2 = Val(0)};
  } else if (to_size_t(arg1.minorOnehot._super[5]._super)) {
    ...
    ECallOutputStruct x13 = exec_ECallHostReadWords(ctx,
                                                    arg0,
                                                    arg1,
                                                    x11._super._super,
                                                    x12._super._super,
                                                    LAYOUT_LOOKUP(layout2, output.arm5._super));
    // ECall0(zirgen/circuit/rv32im/v2/dsl/inst_ecall.zir:158)
    STORE(LAYOUT_LOOKUP(layout2, output.arm5._extra0.count._super), Val(0));
    EQZ(LOAD(LAYOUT_LOOKUP(layout2, output.arm5._extra0.count._super), 0),
        "ECall0(zirgen/circuit/rv32im/v2/dsl/inst_ecall.zir:158)");
  ...
  NormalizeU32Struct x21 =
      exec_NormalizeU32(ctx,
                        DenormedValU32Struct{.low = x20, .high = arg1.pcU32.high},
  ...
  CycleArgStruct x23 =
      exec_CycleArg(ctx, neg_0(x22), arg0._super._super, LAYOUT_LOOKUP(layout2, arg));
  ...
  return InstOutputStruct{.newPc = x21._super, .newState = x6.state, .newMode = Val(1)};
}
...
MultiplyByMIntStruct exec_DoIntRound(ExecContext& ctx,
  ...
  MultiplyByMInt_Super_SuperStruct24Array x14 = MultiplyByMInt_Super_SuperStruct24Array{
      MultiplyByMInt_Super_SuperStruct{._super = (x12 + x13)},
  ...
  return MultiplyByMIntStruct{._super = x14};
}
DoIntRoundsStruct
...
exec_ReadAddr(ExecContext& ctx, RegStruct arg0, Val arg1, BoundLayout<ReadAddrLayout> layout2) {
  ...
  GetDataStruct x3 =
      exec_MemoryRead(ctx, arg0, (arg1 + Val(1073725440)), LAYOUT_LOOKUP(layout2, addr32));
...
PoseidonStateStruct exec_PoseidonEntry(ExecContext& ctx,
  ...
  if (to_size_t(x4._super)) {
    ...
    PoseidonStateStruct x6 =
        exec_PoseidonPagingEntry(ctx, arg0, arg2, LAYOUT_LOOKUP(layout3, _super.arm0._super));
    ...
    PoseidonStateStruct x7 =
        exec_PoseidonEcall(ctx, arg0, arg2, LAYOUT_LOOKUP(layout3, _super.arm1));
    x5 = x7;
  } else {
    assert(0 && "Reached unreachable mux arm");
  }
...
PoseidonStateStruct exec_PoseidonLoadState(ExecContext& ctx,
  ...
  PoseidonOpDefStruct x8 = PoseidonOpDefStruct{.hasState = arg1.hasState._super._super,
                                               .stateAddr = arg1.stateAddr._super._super,
                                               .bufOutAddr = arg1.bufOutAddr._super._super,
                                               .isElem = arg1.isElem._super._super,
                                               .checkOut = arg1.checkOut._super._super,
                                               .loadTxType = arg1.loadTxType._super._super};
...
PoseidonStateStruct exec_PoseidonLoadInShort(ExecContext& ctx,
  ...
  OneHot_3_Struct x5 =
      exec_OneHot_3_(ctx, arg1.loadTxType._super._super, LAYOUT_LOOKUP(layout2, txType));
  // PoseidonLoadInShort(zirgen/circuit/rv32im/v2/dsl/inst_p2.zir:177)
  GetDataStruct8Array x6 =
      map(Val8Array{Val(0), Val(1), Val(2), Val(3), Val(4), Val(5), Val(6), Val(7)},
          LAYOUT_LOOKUP(layout2, loadList),
          ([&](Val8Array::value_type x7, BoundLayout<MemoryGetLayout8LayoutArray::value_type> x8) {
  ...
  PoseidonOpDefStruct x55 = PoseidonOpDefStruct{.hasState = arg1.hasState._super._super,
                                                .stateAddr = arg1.stateAddr._super._super,
                                                .bufOutAddr = arg1.bufOutAddr._super._super,
                                                .isElem = arg1.isElem._super._super,
                                                .checkOut = arg1.checkOut._super._super,
  ...
  PoseidonStateStruct x125 = exec_PoseidonState(
      ctx,
      x55,
      Val(24),
      Val(0),
      ...
      arg1.count._super._super,
      arg1.mode._super._super,
      Val24Array{(x65 + x121),  (x64 + x122),  (x66 + x123),  (x63 + x124),  (x75 + x121),
                 (x74 + x122),  (x76 + x123),  (x73 + x124),  (x85 + x121),  (x84 + x122),
                 (x86 + x123),  (x83 + x124),  (x95 + x121),  (x94 + x122),  (x96 + x123),
                 (x93 + x124),  (x105 + x121), (x104 + x122), (x106 + x123), (x103 + x124),
                 (x115 + x121), (x114 + x122), (x116 + x123), (x113 + x124)},
      (x54 + ((x45 + (x46 * x43)) + (x47 * (x43 * x12._super)))),
      LAYOUT_LOOKUP(layout2, _super));
  return x125;
}
PoseidonStateStruct exec_PoseidonLoadInLow(ExecContext& ctx,
  ...
  PoseidonOpDefStruct x63 = PoseidonOpDefStruct{.hasState = arg1.hasState._super._super,
                                                .stateAddr = arg1.stateAddr._super._super,
                                                .bufOutAddr = arg1.bufOutAddr._super._super,
                                                .isElem = arg1.isElem._super._super,
                                                .checkOut = arg1.checkOut._super._super,
  ...
  Val24Array x65 = Val24Array{
      (x55 + x6[0]._super.low),     (x56 + x6[1]._super.low),     (x57 + x6[2]._super.low),
      (x58 + x6[3]._super.low),     (x59 + x6[4]._super.low),     (x60 + x6[5]._super.low),
      (x61 + x6[6]._super.low),     (x62 + x6[7]._super.low),     arg1.inner[8]._super._super,
      arg1.inner[9]._super._super,  arg1.inner[10]._super._super, arg1.inner[11]._super._super,
      arg1.inner[12]._super._super, arg1.inner[13]._super._super, arg1.inner[14]._super._super,
      arg1.inner[15]._super._super, arg1.inner[16]._super._super, arg1.inner[17]._super._super,
      arg1.inner[18]._super._super, arg1.inner[19]._super._super, arg1.inner[20]._super._super,
      arg1.inner[21]._super._super, arg1.inner[22]._super._super, arg1.inner[23]._super._super};
  // PoseidonLoadInLow(zirgen/circuit/rv32im/v2/dsl/inst_p2.zir:211)
  PoseidonStateStruct x66 =
      exec_PoseidonState(ctx,
                         x63,
                         Val(18),
                         Val(1),
...
PoseidonStateStruct exec_PoseidonLoadInHigh(ExecContext& ctx,
  ...
  PoseidonOpDefStruct x67 = PoseidonOpDefStruct{.hasState = arg1.hasState._super._super,
                                                .stateAddr = arg1.stateAddr._super._super,
                                                .bufOutAddr = arg1.bufOutAddr._super._super,
                                                .isElem = arg1.isElem._super._super,
                                                .checkOut = arg1.checkOut._super._super,
  ...
  PoseidonStateStruct x133 = exec_PoseidonState(
      ctx,
      x67,
      Val(24),
      Val(0),
      ...
      arg1.count._super._super,
      arg1.mode._super._super,
      Val24Array{(x77 + x129),  (x76 + x130),  (x78 + x131),  (x75 + x132),  (x87 + x129),
                 (x86 + x130),  (x88 + x131),  (x85 + x132),  (x95 + x129),  (x94 + x130),
                 (x96 + x131),  (x93 + x132),  (x103 + x129), (x102 + x130), (x104 + x131),
                 (x101 + x132), (x113 + x129), (x112 + x130), (x114 + x131), (x111 + x132),
                 (x123 + x129), (x122 + x130), (x124 + x131), (x121 + x132)},
      (x66 + ((x57 + (x58 * x55)) + (x59 * (x55 * x24._super)))),
      LAYOUT_LOOKUP(layout2, _super));
  return x133;
}
PoseidonStateStruct exec_PoseidonLoadIn(ExecContext& ctx,
  ...
  if (to_size_t(x5._super[0]._super)) {
    ...
    PoseidonStateStruct x7 =
        exec_PoseidonLoadInShort(ctx, arg0, arg1, LAYOUT_LOOKUP(layout2, _super.arm0), global3);
    x6 = x7;
  } else if (to_size_t(x5._super[1]._super)) {
    // PoseidonLoadIn(zirgen/circuit/rv32im/v2/dsl/inst_p2.zir:235)
    PoseidonStateStruct x8 =
        exec_PoseidonLoadInLow(ctx, arg0, arg1, LAYOUT_LOOKUP(layout2, _super.arm1), global3);
    x6 = x8;
  } else if (to_size_t(x5._super[2]._super)) {
    // PoseidonLoadIn(zirgen/circuit/rv32im/v2/dsl/inst_p2.zir:236)
    PoseidonStateStruct x9 =
        exec_PoseidonLoadInHigh(ctx, arg0, arg1, LAYOUT_LOOKUP(layout2, _super.arm2), global3);
    x6 = x9;
  } else {
    assert(0 && "Reached unreachable mux arm");
  }
...
PoseidonStateStruct exec_PoseidonExtRound(ExecContext& ctx,
  ...
  Val24Array x14 = Val24Array{
      arg0.inner[0]._super._super,  arg0.inner[1]._super._super,  arg0.inner[2]._super._super,
      arg0.inner[3]._super._super,  arg0.inner[4]._super._super,  arg0.inner[5]._super._super,
      arg0.inner[6]._super._super,  arg0.inner[7]._super._super,  arg0.inner[8]._super._super,
      arg0.inner[9]._super._super,  arg0.inner[10]._super._super, arg0.inner[11]._super._super,
      arg0.inner[12]._super._super, arg0.inner[13]._super._super, arg0.inner[14]._super._super,
      arg0.inner[15]._super._super, arg0.inner[16]._super._super, arg0.inner[17]._super._super,
      arg0.inner[18]._super._super, arg0.inner[19]._super._super, arg0.inner[20]._super._super,
      arg0.inner[21]._super._super, arg0.inner[22]._super._super, arg0.inner[23]._super._super};
  // PoseidonExtRound(zirgen/circuit/rv32im/v2/dsl/inst_p2.zir:252)
  MultiplyByMExtStruct x15 = exec_DoExtRoundByIdx(
      ctx, x14, arg0.subState._super._super, LAYOUT_LOOKUP(layout1, nextInner));
  // PoseidonOpDef(zirgen/circuit/rv32im/v2/dsl/inst_p2.zir:8)
  // GetDef(zirgen/circuit/rv32im/v2/dsl/inst_p2.zir:72)
  // PoseidonExtRound(zirgen/circuit/rv32im/v2/dsl/inst_p2.zir:253)
  PoseidonOpDefStruct x16 = PoseidonOpDefStruct{.hasState = arg0.hasState._super._super,
                                                .stateAddr = arg0.stateAddr._super._super,
                                                .bufOutAddr = arg0.bufOutAddr._super._super,
                                                .isElem = arg0.isElem._super._super,
                                                .checkOut = arg0.checkOut._super._super,
                                                .loadTxType = arg0.loadTxType._super._super};
  // PoseidonExtRound(zirgen/circuit/rv32im/v2/dsl/inst_p2.zir:252)
  ...
  PoseidonStateStruct x18 = exec_PoseidonState(ctx,
                                               ...
                                               ((x10 + (x11 * Val(18))) + x12),
                                               (x9 * x13),
                                               arg0.bufInAddr._super._super,
                                               x8,
                                               arg0.mode._super._super,
                                               x17,
                                               arg0.zcheck._super,
                                               LAYOUT_LOOKUP(layout1, _super));
  return x18;
...
PoseidonStateStruct exec_PoseidonIntRounds(ExecContext& ctx,
  ...
  PoseidonOpDefStruct x4 = PoseidonOpDefStruct{.hasState = arg0.hasState._super._super,
                                               .stateAddr = arg0.stateAddr._super._super,
                                               .bufOutAddr = arg0.bufOutAddr._super._super,
                                               .isElem = arg0.isElem._super._super,
                                               .checkOut = arg0.checkOut._super._super,
...
PoseidonStateStruct exec_PoseidonCheckOut(ExecContext& ctx,
  ...
  NondetRegStruct x9 =
      exec_IsZero(ctx, arg1.loadTxType._super._super, LAYOUT_LOOKUP(layout2, isNormal));
  ...
  PoseidonOpDefStruct x17 = PoseidonOpDefStruct{.hasState = arg1.hasState._super._super,
                                                .stateAddr = arg1.stateAddr._super._super,
                                                .bufOutAddr = arg1.bufOutAddr._super._super,
                                                .isElem = arg1.isElem._super._super,
                                                .checkOut = arg1.checkOut._super._super,
  ...
  Val24Array x18 = Val24Array{
      arg1.inner[0]._super._super,  arg1.inner[1]._super._super,  arg1.inner[2]._super._super,
      arg1.inner[3]._super._super,  arg1.inner[4]._super._super,  arg1.inner[5]._super._super,
      arg1.inner[6]._super._super,  arg1.inner[7]._super._super,  arg1.inner[8]._super._super,
      arg1.inner[9]._super._super,  arg1.inner[10]._super._super, arg1.inner[11]._super._super,
      arg1.inner[12]._super._super, arg1.inner[13]._super._super, arg1.inner[14]._super._super,
      arg1.inner[15]._super._super, arg1.inner[16]._super._super, arg1.inner[17]._super._super,
      arg1.inner[18]._super._super, arg1.inner[19]._super._super, arg1.inner[20]._super._super,
      arg1.inner[21]._super._super, arg1.inner[22]._super._super, arg1.inner[23]._super._super};
  // PoseidonCheckOut(zirgen/circuit/rv32im/v2/dsl/inst_p2.zir:276)
  PoseidonStateStruct x19 = exec_PoseidonState(ctx,
                                               x17,
                                               (x12 + (x13 * x11)),
                                               Val(0),
                                               Val(0),
...
PoseidonStateStruct exec_PoseidonStoreOut(ExecContext& ctx,
          ...
          ([&](Val8Array::value_type x4,
            ...
            MemoryWriteStruct x11 =
                exec_MemoryWrite(ctx,
                                 arg0,
                                 x10,
                                 ValU32Struct{.low = x7._super, .high = x9._super},
                                 LAYOUT_LOOKUP(x5, _0));
  ...
  PoseidonOpDefStruct x19 = PoseidonOpDefStruct{.hasState = arg1.hasState._super._super,
                                                .stateAddr = arg1.stateAddr._super._super,
                                                .bufOutAddr = arg1.bufOutAddr._super._super,
                                                .isElem = arg1.isElem._super._super,
                                                .checkOut = arg1.checkOut._super._super,
  ...
  Val24Array x20 = Val24Array{
      ...
      arg1.inner[21]._super._super, arg1.inner[22]._super._super, arg1.inner[23]._super._super};
  // PoseidonStoreOut(zirgen/circuit/rv32im/v2/dsl/inst_p2.zir:292)
  PoseidonStateStruct x21 = exec_PoseidonState(ctx,
                                               x19,
                                               (x15 + (x16 * x14)),
                                               Val(0),
                                               Val(0),
...
PoseidonStateStruct exec_PoseidonDoOut(ExecContext& ctx,
  ...
  if (to_size_t(arg1.checkOut._super._super)) {
    PoseidonStateStruct x5 =
        exec_PoseidonCheckOut(ctx, arg0, arg1, LAYOUT_LOOKUP(layout2, _super.arm0._super));
    STORE(LAYOUT_LOOKUP(layout2, _super.arm0._extra0.count._super), Val(0));
    EQZ(LOAD(LAYOUT_LOOKUP(layout2, _super.arm0._extra0.count._super), 0),
        "PoseidonDoOut(zirgen/circuit/rv32im/v2/dsl/inst_p2.zir:296)");
    STORE(LAYOUT_LOOKUP(layout2, _super.arm0._extra1.count._super), Val(0));
    ...
    PoseidonStateStruct x6 =
        exec_PoseidonStoreOut(ctx, arg0, arg1, LAYOUT_LOOKUP(layout2, _super.arm1));
    x4 = x6;
  } else {
    assert(0 && "Reached unreachable mux arm");
  }
...
PoseidonStateStruct exec_PoseidonStoreState(ExecContext& ctx,
  ...
  PoseidonOpDefStruct x12 = PoseidonOpDefStruct{.hasState = arg1.hasState._super._super,
                                                .stateAddr = arg1.stateAddr._super._super,
                                                .bufOutAddr = arg1.bufOutAddr._super._super,
                                                .isElem = arg1.isElem._super._super,
                                                .checkOut = arg1.checkOut._super._super,
  ...
  Val24Array x13 = Val24Array{
      ...
      arg1.inner[21]._super._super, arg1.inner[22]._super._super, arg1.inner[23]._super._super};
  // PoseidonStoreState(zirgen/circuit/rv32im/v2/dsl/inst_p2.zir:306)
  PoseidonStateStruct x14 = exec_PoseidonState(ctx,
                                               x12,
                                               Val(32),
                                               Val(0),
                                               Val(0),
...
InstOutputStruct exec_Poseidon0(ExecContext& ctx,
  ...
  if (to_size_t(arg1.minorOnehot._super[0]._super)) {
    ...
    PoseidonStateStruct x5 = exec_PoseidonEntry(
        ctx, arg0, arg1.pcU32, arg1.mode, LAYOUT_LOOKUP(layout2, stateRedef.arm0._super));
    ...
    PoseidonStateStruct x7 =
        exec_PoseidonLoadState(ctx, arg0, x6, LAYOUT_LOOKUP(layout2, stateRedef.arm1._super));
    // Poseidon0(zirgen/circuit/rv32im/v2/dsl/inst_p2.zir:448)
    ...
    PoseidonStateStruct x9 =
        exec_PoseidonLoadIn(ctx, arg0, x8, LAYOUT_LOOKUP(layout2, stateRedef.arm2._super), global3);
    // Poseidon0(zirgen/circuit/rv32im/v2/dsl/inst_p2.zir:448)
    ...
    PoseidonStateStruct x13 =
        exec_PoseidonDoOut(ctx, arg0, x12, LAYOUT_LOOKUP(layout2, stateRedef.arm5._super));
    // Poseidon0(zirgen/circuit/rv32im/v2/dsl/inst_p2.zir:448)
    ...
    PoseidonStateStruct x15 = exec_PoseidonPaging(
        ctx, arg0, arg1.mode, x14, LAYOUT_LOOKUP(layout2, stateRedef.arm6._super));
    // Poseidon0(zirgen/circuit/rv32im/v2/dsl/inst_p2.zir:448)
    ...
    PoseidonStateStruct x17 =
        exec_PoseidonStoreState(ctx, arg0, x16, LAYOUT_LOOKUP(layout2, stateRedef.arm7._super));
    // Poseidon0(zirgen/circuit/rv32im/v2/dsl/inst_p2.zir:448)
  ...
  CycleArgStruct x19 =
      exec_CycleArg(ctx, neg_0(x18), arg0._super._super, LAYOUT_LOOKUP(layout2, arg));
  ...
  InstOutputStruct x22 = InstOutputStruct{.newPc = arg1.pcU32,
                                          .newState = x21.nextState._super._super,
                                          .newMode = x21.mode._super._super};
  return x22;
}
InstOutputStruct exec_Poseidon1(ExecContext& ctx,
  ...
  if (to_size_t(arg1.minorOnehot._super[0]._super)) {
    ...
    PoseidonStateStruct x5 =
        exec_PoseidonExtRound(ctx, x4, LAYOUT_LOOKUP(layout2, stateRedef.arm0));
    x3 = x5;
  } else if (to_size_t(arg1.minorOnehot._super[1]._super)) {
    // Poseidon1(zirgen/circuit/rv32im/v2/dsl/inst_p2.zir:469)
    PoseidonStateStruct x6 = back_PoseidonState(ctx, 1, LAYOUT_LOOKUP(layout2, state));
    PoseidonStateStruct x7 =
        exec_PoseidonIntRounds(ctx, x6, LAYOUT_LOOKUP(layout2, stateRedef.arm1));
    x3 = x7;
  } else if (to_size_t(arg1.minorOnehot._super[2]._super)) {
  ...
  CycleArgStruct x15 =
      exec_CycleArg(ctx, neg_0(x14), arg0._super._super, LAYOUT_LOOKUP(layout2, arg));
  ...
  InstOutputStruct x18 = InstOutputStruct{.newPc = arg1.pcU32,
                                          .newState = x17.nextState._super._super,
                                          .newMode = x17.mode._super._super};
  return x18;
}
OneHot_11_Struct
...
TopStruct exec_Top(ExecContext& ctx, BoundLayout<TopLayout> layout0, GlobalBuf global1) {
  ...
  InstInputStruct x16 =
      exec_InstInput(ctx,
                     ...
                     x14._super,
                     x15._super,
                     ValU32Struct{.low = (x7 * x8._super._super), .high = (x7 * x9._super._super)},
                     (x7 * x10._super._super),
                     ((x7 * x11._super._super) + x3._super),
  ...
  if (to_size_t(x17._super[0]._super)) {
    ...
    InstOutputStruct x26 =
        exec_Control0(ctx, x6, x16, LAYOUT_LOOKUP(layout0, instResult.arm7), global1);
    x18 = x26;
  } else if (to_size_t(x17._super[8]._super)) {
    // Top(zirgen/circuit/rv32im/v2/dsl/top.zir:78)
    InstOutputStruct x27 =
        exec_ECall0(ctx, x6, x16, LAYOUT_LOOKUP(layout0, instResult.arm8), global1);
    x18 = x27;
  } else if (to_size_t(x17._super[9]._super)) {
    // Top(zirgen/circuit/rv32im/v2/dsl/top.zir:79)
    InstOutputStruct x28 =
        exec_Poseidon0(ctx, x6, x16, LAYOUT_LOOKUP(layout0, instResult.arm9), global1);
    x18 = x28;
  ...
  std::initializer_list<Val> x32 =
      std::initializer_list<Val>{x6._super._super, (x30 + x31), x18.newState, x18.newMode};
  // Log(<preamble>:22)
  ...
  if (to_size_t(LOAD(
    ...
    ExtVal x14 =
        (LOAD(LAYOUT_LOOKUP(arg0, instResult.arm0._super.writeData.low16.arg.count._super), 0) *
         x11);
    // zirgen/dsl/passes/GenerateAccum.cpp:146
    ExtVal x15 = (LOAD_EXT(LAYOUT_LOOKUP(x3, randomness.argU16.val), 0) *
    ...
    ExtVal x19 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 0), 0) -
    ...
    ExtVal x23 =
        (LOAD(LAYOUT_LOOKUP(arg0, instResult.arm0._super.pcNorm.high16.arg.count._super), 0) *
         inv_0(x22));
    // zirgen/dsl/passes/GenerateAccum.cpp:146
    ExtVal x24 = (LOAD_EXT(LAYOUT_LOOKUP(x3, randomness.memoryArg.addr), 0) *
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:223
    ExtVal x32 =
        (LOAD(LAYOUT_LOOKUP(arg0, instResult.arm0._super.pcNorm.high16.arg.count._super), 0) * x29);
    // zirgen/dsl/passes/GenerateAccum.cpp:146
    ExtVal x33 = (LOAD_EXT(LAYOUT_LOOKUP(x3, randomness.memoryArg.addr), 0) *
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x41 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 1), 0) -
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:182
    EQZ((x42 -
         (x31 * LOAD(LAYOUT_LOOKUP(arg0, instResult.arm0._super._0._0.io.newTxn.count._super), 0))),
        "zirgen/dsl/passes/GenerateAccum.cpp:182");
    // zirgen/dsl/passes/GenerateAccum.cpp:146
    ExtVal x43 =
    ...
    ExtVal x45 =
        (LOAD(LAYOUT_LOOKUP(arg0, instResult.arm0._super._0._0._0._0.arg.count._super), 0) *
         inv_0(x44));
    // zirgen/dsl/passes/GenerateAccum.cpp:146
    ExtVal x46 = (LOAD_EXT(LAYOUT_LOOKUP(x3, randomness.cycleArg.cycle), 0) *
                  LOAD(LAYOUT_LOOKUP(arg0, instResult.arm0.input.decoded.arg.cycle._super), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:238
    ExtVal x47 = (x46 + LOAD_EXT(LAYOUT_LOOKUP(x3, randomness._offset), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:240
    ExtVal x48 =
        (LOAD(LAYOUT_LOOKUP(arg0, instResult.arm0.input.decoded.arg.count._super), 0) * inv_0(x47));
    // zirgen/dsl/passes/GenerateAccum.cpp:217
    ExtVal x49 = (x44 * x47);
    // zirgen/dsl/passes/GenerateAccum.cpp:223
    ExtVal x50 =
        (LOAD(LAYOUT_LOOKUP(arg0, instResult.arm0._super._0._0._0._0.arg.count._super), 0) * x47);
    // zirgen/dsl/passes/GenerateAccum.cpp:146
    ExtVal x51 = (LOAD_EXT(LAYOUT_LOOKUP(x3, randomness.argU16.val), 0) *
                  LOAD(LAYOUT_LOOKUP(
                           arg0, instResult.arm0.input.decoded.pcAddr.upperDiff.ret.arg.val._super),
                       0));
    // zirgen/dsl/passes/GenerateAccum.cpp:238
    ...
    ExtVal x53 =
        (LOAD(LAYOUT_LOOKUP(arg0,
                            instResult.arm0.input.decoded.pcAddr.upperDiff.ret.arg.count._super),
              0) *
         inv_0(x52));
    // zirgen/dsl/passes/GenerateAccum.cpp:241
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x55 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 2), 0) -
                  LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 1), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:180
    ExtVal x56 =
        (((x55 * (x49 * x52)) - (x50 * x52)) -
         ((x44 * LOAD(LAYOUT_LOOKUP(arg0, instResult.arm0.input.decoded.arg.count._super), 0)) *
          x52));
    // zirgen/dsl/passes/GenerateAccum.cpp:182
    EQZ((x56 -
         (x49 * LOAD(LAYOUT_LOOKUP(
                         arg0, instResult.arm0.input.decoded.pcAddr.upperDiff.ret.arg.count._super),
                     0))),
        "zirgen/dsl/passes/GenerateAccum.cpp:182");
    // zirgen/dsl/passes/GenerateAccum.cpp:146
    ExtVal x57 =
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x77 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 3), 0) -
    ...
    ExtVal x78 =
        (((x77 * (x67 * x74)) - (x68 * x74)) -
         ((x58 *
          ...
          x74));
    // zirgen/dsl/passes/GenerateAccum.cpp:182
    EQZ((x78 - (x67 * LOAD(LAYOUT_LOOKUP(
                               arg0, instResult.arm0.input.decoded.loadInst.io.newTxn.count._super),
                           0))),
        "zirgen/dsl/passes/GenerateAccum.cpp:182");
    // zirgen/dsl/passes/GenerateAccum.cpp:146
    ExtVal x79 =
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x99 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 4), 0) -
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x121 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 5), 0) -
                   LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 4), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:180
    ExtVal x122 =
        (((x121 * (x111 * x118)) - (x112 * x118)) -
         ((x102 *
           LOAD(LAYOUT_LOOKUP(arg0, instResult.arm0.input.rs2._super.io.oldTxn.count._super), 0)) *
          x118));
    // zirgen/dsl/passes/GenerateAccum.cpp:182
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x135 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 6), 0) -
                   LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 5), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:180
    ExtVal x136 =
        (((x135 * (x129 * x132)) - (x130 * x132)) -
         ((x124 *
           LOAD(LAYOUT_LOOKUP(
                    LAYOUT_SUBSCRIPT(
                        LAYOUT_LOOKUP(arg0, instResult.arm0._arguments_Misc0MiscOutput.argU16), 0),
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x149 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 7), 0) -
                   LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 6), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:180
    ExtVal x150 =
        (((x149 * (x143 * x146)) - (x144 * x146)) -
         ((x138 *
           LOAD(LAYOUT_LOOKUP(
                    LAYOUT_SUBSCRIPT(
                        LAYOUT_LOOKUP(arg0, instResult.arm0._arguments_Misc0MiscOutput.argU16), 3),
    ...
    ExtVal x151 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 18), 0) -
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x165 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 0), 0) -
                   LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 18), 1));
    // zirgen/dsl/passes/GenerateAccum.cpp:180
    ExtVal x166 =
        (((x165 * (x159 * x162)) - (x160 * x162)) -
         ((x153 *
           LOAD(LAYOUT_LOOKUP(arg0, instResult.arm1._super.writeData.high16.arg.count._super), 0)) *
          x162));
    // zirgen/dsl/passes/GenerateAccum.cpp:182
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x187 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 1), 0) -
                   LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 0), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:180
    ExtVal x188 =
        (((x187 * (x177 * x184)) - (x178 * x184)) -
         ((x168 *
           LOAD(LAYOUT_LOOKUP(arg0, instResult.arm1._super._0._0.io.oldTxn.count._super), 0)) *
          x184));
    // zirgen/dsl/passes/GenerateAccum.cpp:182
    ...
    ExtVal x191 =
        (LOAD(LAYOUT_LOOKUP(arg0, instResult.arm1._super._0._0._0._0.arg.count._super), 0) *
         inv_0(x190));
    // zirgen/dsl/passes/GenerateAccum.cpp:146
    ExtVal x192 = (LOAD_EXT(LAYOUT_LOOKUP(x3, randomness.cycleArg.cycle), 0) *
                   LOAD(LAYOUT_LOOKUP(arg0, instResult.arm1.input.decoded.arg.cycle._super), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:238
    ExtVal x193 = (x192 + LOAD_EXT(LAYOUT_LOOKUP(x3, randomness._offset), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:240
    ExtVal x194 = (LOAD(LAYOUT_LOOKUP(arg0, instResult.arm1.input.decoded.arg.count._super), 0) *
                   inv_0(x193));
    // zirgen/dsl/passes/GenerateAccum.cpp:217
    ExtVal x195 = (x190 * x193);
    // zirgen/dsl/passes/GenerateAccum.cpp:223
    ExtVal x196 =
        (LOAD(LAYOUT_LOOKUP(arg0, instResult.arm1._super._0._0._0._0.arg.count._super), 0) * x193);
    // zirgen/dsl/passes/GenerateAccum.cpp:146
    ExtVal x197 =
        (LOAD_EXT(LAYOUT_LOOKUP(x3, randomness.argU16.val), 0) *
         LOAD(
             LAYOUT_LOOKUP(arg0, instResult.arm1.input.decoded.pcAddr.upperDiff.ret.arg.val._super),
             0));
    // zirgen/dsl/passes/GenerateAccum.cpp:238
    ...
    ExtVal x199 =
        (LOAD(LAYOUT_LOOKUP(arg0,
                            instResult.arm1.input.decoded.pcAddr.upperDiff.ret.arg.count._super),
              0) *
         inv_0(x198));
    // zirgen/dsl/passes/GenerateAccum.cpp:241
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x201 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 2), 0) -
                   LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 1), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:180
    ExtVal x202 =
        (((x201 * (x195 * x198)) - (x196 * x198)) -
         ((x190 * LOAD(LAYOUT_LOOKUP(arg0, instResult.arm1.input.decoded.arg.count._super), 0)) *
          x198));
    // zirgen/dsl/passes/GenerateAccum.cpp:182
    EQZ((x202 -
         (x195 *
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x223 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 3), 0) -
                   LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 2), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:180
    ExtVal x224 =
        (((x223 * (x213 * x220)) - (x214 * x220)) -
         ((x204 *
           LOAD(LAYOUT_LOOKUP(arg0, instResult.arm1.input.decoded.loadInst.io.oldTxn.count._super),
                0)) *
          x220));
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x245 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 4), 0) -
                   LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 3), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:180
    ExtVal x246 =
        (((x245 * (x235 * x242)) - (x236 * x242)) -
         ((x226 *
           LOAD(LAYOUT_LOOKUP(arg0, instResult.arm1.input.rs1._super.io.oldTxn.count._super), 0)) *
          x242));
    // zirgen/dsl/passes/GenerateAccum.cpp:182
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x267 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 5), 0) -
                   LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 4), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:180
    ExtVal x268 =
        (((x267 * (x257 * x264)) - (x258 * x264)) -
         ((x248 *
           LOAD(LAYOUT_LOOKUP(arg0, instResult.arm1.input.rs2._super.io.oldTxn.count._super), 0)) *
          x264));
    // zirgen/dsl/passes/GenerateAccum.cpp:182
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x281 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 6), 0) -
                   LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 5), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:180
    ExtVal x282 =
        (((x281 * (x275 * x278)) - (x276 * x278)) -
         ((x270 *
           LOAD(LAYOUT_LOOKUP(
                    LAYOUT_SUBSCRIPT(
                        LAYOUT_LOOKUP(arg0, instResult.arm1._arguments_Misc1MiscOutput.argU16), 0),
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x295 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 7), 0) -
                   LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 6), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:180
    ExtVal x296 =
        (((x295 * (x289 * x292)) - (x290 * x292)) -
         ((x284 *
           LOAD(LAYOUT_LOOKUP(
                    LAYOUT_SUBSCRIPT(
                        LAYOUT_LOOKUP(arg0, instResult.arm1._arguments_Misc1MiscOutput.argU16), 3),
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:124
    ExtVal x297 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 18), 0) -
                   LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 7), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:125
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x311 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 0), 0) -
                   LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 18), 1));
    // zirgen/dsl/passes/GenerateAccum.cpp:180
    ExtVal x312 =
        (((x311 * (x305 * x308)) - (x306 * x308)) -
         ((x299 *
           LOAD(LAYOUT_LOOKUP(arg0, instResult.arm2._super.writeData.high16.arg.count._super), 0)) *
          x308));
    // zirgen/dsl/passes/GenerateAccum.cpp:182
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x333 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 1), 0) -
                   LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 0), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:180
    ExtVal x334 =
        (((x333 * (x323 * x330)) - (x324 * x330)) -
         ((x314 *
           LOAD(LAYOUT_LOOKUP(arg0, instResult.arm2._super._0._0.io.oldTxn.count._super), 0)) *
          x330));
    // zirgen/dsl/passes/GenerateAccum.cpp:182
    ...
    ExtVal x337 =
        (LOAD(LAYOUT_LOOKUP(arg0, instResult.arm2._super._0._0._0._0.arg.count._super), 0) *
         inv_0(x336));
    // zirgen/dsl/passes/GenerateAccum.cpp:146
    ExtVal x338 = (LOAD_EXT(LAYOUT_LOOKUP(x3, randomness.cycleArg.cycle), 0) *
                   LOAD(LAYOUT_LOOKUP(arg0, instResult.arm2.input.decoded.arg.cycle._super), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:238
    ExtVal x339 = (x338 + LOAD_EXT(LAYOUT_LOOKUP(x3, randomness._offset), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:240
    ExtVal x340 = (LOAD(LAYOUT_LOOKUP(arg0, instResult.arm2.input.decoded.arg.count._super), 0) *
                   inv_0(x339));
    // zirgen/dsl/passes/GenerateAccum.cpp:217
    ExtVal x341 = (x336 * x339);
    // zirgen/dsl/passes/GenerateAccum.cpp:223
    ExtVal x342 =
        (LOAD(LAYOUT_LOOKUP(arg0, instResult.arm2._super._0._0._0._0.arg.count._super), 0) * x339);
    // zirgen/dsl/passes/GenerateAccum.cpp:146
    ExtVal x343 =
        (LOAD_EXT(LAYOUT_LOOKUP(x3, randomness.argU16.val), 0) *
         LOAD(
             LAYOUT_LOOKUP(arg0, instResult.arm2.input.decoded.pcAddr.upperDiff.ret.arg.val._super),
             0));
    // zirgen/dsl/passes/GenerateAccum.cpp:238
    ...
    ExtVal x345 =
        (LOAD(LAYOUT_LOOKUP(arg0,
                            instResult.arm2.input.decoded.pcAddr.upperDiff.ret.arg.count._super),
              0) *
         inv_0(x344));
    // zirgen/dsl/passes/GenerateAccum.cpp:241
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x347 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 2), 0) -
                   LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 1), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:180
    ExtVal x348 =
        (((x347 * (x341 * x344)) - (x342 * x344)) -
         ((x336 * LOAD(LAYOUT_LOOKUP(arg0, instResult.arm2.input.decoded.arg.count._super), 0)) *
          x344));
    // zirgen/dsl/passes/GenerateAccum.cpp:182
    EQZ((x348 -
         (x341 *
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x369 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 3), 0) -
                   LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 2), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:180
    ExtVal x370 =
        (((x369 * (x359 * x366)) - (x360 * x366)) -
         ((x350 *
           LOAD(LAYOUT_LOOKUP(arg0, instResult.arm2.input.decoded.loadInst.io.oldTxn.count._super),
                0)) *
          x366));
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x391 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 4), 0) -
                   LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 3), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:180
    ExtVal x392 =
        (((x391 * (x381 * x388)) - (x382 * x388)) -
         ((x372 *
           LOAD(LAYOUT_LOOKUP(arg0, instResult.arm2.input.rs1._super.io.oldTxn.count._super), 0)) *
          x388));
    // zirgen/dsl/passes/GenerateAccum.cpp:182
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x413 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 5), 0) -
                   LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 4), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:180
    ExtVal x414 =
        (((x413 * (x403 * x410)) - (x404 * x410)) -
         ((x394 *
           LOAD(LAYOUT_LOOKUP(arg0, instResult.arm2.input.rs2._super.io.oldTxn.count._super), 0)) *
          x410));
    // zirgen/dsl/passes/GenerateAccum.cpp:182
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x427 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 6), 0) -
                   LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 5), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:180
    ExtVal x428 =
        (((x427 * (x421 * x424)) - (x422 * x424)) -
         ((x416 *
           LOAD(LAYOUT_LOOKUP(
                    LAYOUT_SUBSCRIPT(
                        LAYOUT_LOOKUP(arg0, instResult.arm2._arguments_Misc2MiscOutput.argU16), 0),
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x441 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 7), 0) -
                   LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 6), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:180
    ExtVal x442 =
        (((x441 * (x435 * x438)) - (x436 * x438)) -
         ((x430 *
           LOAD(LAYOUT_LOOKUP(
                    LAYOUT_SUBSCRIPT(
                        LAYOUT_LOOKUP(arg0, instResult.arm2._arguments_Misc2MiscOutput.argU16), 3),
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:124
    ExtVal x443 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 18), 0) -
                   LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 7), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:125
    ...
    x5 = x4;
                 ...
                 LOAD(LAYOUT_LOOKUP(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(arg0, instResult._selector), 3),
                      ...
                      0))) {
    // zirgen/dsl/passes/GenerateAccum.cpp:146
    ExtVal x444 = (LOAD_EXT(LAYOUT_LOOKUP(x3, randomness.cycleArg.cycle), 0) *
                   LOAD(LAYOUT_LOOKUP(arg0, instResult.arm3.input.decoded.arg.cycle._super), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:238
    ExtVal x445 = (x444 + LOAD_EXT(LAYOUT_LOOKUP(x3, randomness._offset), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:240
    ExtVal x446 = (LOAD(LAYOUT_LOOKUP(arg0, instResult.arm3.input.decoded.arg.count._super), 0) *
                   inv_0(x445));
    // zirgen/dsl/passes/GenerateAccum.cpp:241
    ...
    ExtVal x448 =
        (LOAD_EXT(LAYOUT_LOOKUP(x3, randomness.argU16.val), 0) *
         LOAD(
             LAYOUT_LOOKUP(arg0, instResult.arm3.input.decoded.pcAddr.upperDiff.ret.arg.val._super),
             0));
    // zirgen/dsl/passes/GenerateAccum.cpp:238
    ...
    ExtVal x450 =
        (LOAD(LAYOUT_LOOKUP(arg0,
                            instResult.arm3.input.decoded.pcAddr.upperDiff.ret.arg.count._super),
              0) *
         inv_0(x449));
    // zirgen/dsl/passes/GenerateAccum.cpp:217
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:223
    ExtVal x452 =
        (LOAD(LAYOUT_LOOKUP(arg0, instResult.arm3.input.decoded.arg.count._super), 0) * x449);
    // zirgen/dsl/passes/GenerateAccum.cpp:146
    ExtVal x453 =
        (LOAD_EXT(LAYOUT_LOOKUP(x3, randomness.argU16.val), 0) *
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x457 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 0), 0) -
                   LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 18), 1));
    // zirgen/dsl/passes/GenerateAccum.cpp:180
    ExtVal x458 =
        (((x457 * (x451 * x454)) - (x452 * x454)) -
         ((x445 *
           LOAD(LAYOUT_LOOKUP(arg0,
                              instResult.arm3.input.decoded.pcAddr.upperDiff.ret.arg.count._super),
                0)) *
          x454));
    // zirgen/dsl/passes/GenerateAccum.cpp:182
    EQZ((x458 - (x451 * LOAD(LAYOUT_LOOKUP(
                                 arg0, instResult.arm3.input.decoded.pcAddr.med14.arg.count._super),
                             0))),
        "zirgen/dsl/passes/GenerateAccum.cpp:182");
    // zirgen/dsl/passes/GenerateAccum.cpp:146
    ExtVal x459 =
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x479 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 1), 0) -
                   LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 0), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:180
    ExtVal x480 =
        (((x479 * (x473 * x476)) - (x474 * x476)) -
         ((x464 *
           LOAD(LAYOUT_LOOKUP(arg0, instResult.arm3.input.decoded.loadInst.io.newTxn.count._super),
                0)) *
          x476));
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x501 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 2), 0) -
                   LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 1), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:180
    ExtVal x502 =
        (((x501 * (x495 * x498)) - (x496 * x498)) -
         ((x486 *
           LOAD(LAYOUT_LOOKUP(arg0, instResult.arm3.input.rs1._super.io.newTxn.count._super), 0)) *
          x498));
    // zirgen/dsl/passes/GenerateAccum.cpp:182
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x523 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 3), 0) -
                   LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 2), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:180
    ExtVal x524 =
        (((x523 * (x517 * x520)) - (x518 * x520)) -
         ((x508 *
           LOAD(LAYOUT_LOOKUP(arg0, instResult.arm3.input.rs2._super.io.newTxn.count._super), 0)) *
          x520));
    // zirgen/dsl/passes/GenerateAccum.cpp:182
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x537 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 4), 0) -
                   LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 3), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:180
    ExtVal x538 =
        (((x537 * (x531 * x534)) - (x532 * x534)) -
         ((x526 *
           LOAD(LAYOUT_LOOKUP(
                    LAYOUT_SUBSCRIPT(
                        LAYOUT_LOOKUP(arg0, instResult.arm3._arguments_Mul0MulOutput.argU16), 1),
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x551 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 5), 0) -
                   LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 4), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:180
    ExtVal x552 =
        (((x551 * (x545 * x548)) - (x546 * x548)) -
         ((x540 *
           LOAD(LAYOUT_LOOKUP(
                    LAYOUT_SUBSCRIPT(
                        LAYOUT_LOOKUP(arg0, instResult.arm3._arguments_Mul0MulOutput.argU16), 4),
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x565 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 6), 0) -
                   LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 5), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:180
    ExtVal x566 =
        (((x565 * (x559 * x562)) - (x560 * x562)) -
         ((x554 *
           LOAD(LAYOUT_LOOKUP(
                    LAYOUT_SUBSCRIPT(
                        LAYOUT_LOOKUP(arg0, instResult.arm3._arguments_Mul0MulOutput.argU8), 1),
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x579 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 7), 0) -
                   LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 6), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:180
    ExtVal x580 =
        (((x579 * (x573 * x576)) - (x574 * x576)) -
         ((x568 *
           LOAD(LAYOUT_LOOKUP(
                    LAYOUT_SUBSCRIPT(
                        LAYOUT_LOOKUP(arg0, instResult.arm3._arguments_Mul0MulOutput.argU8), 4),
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x593 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 8), 0) -
                   LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 7), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:180
    ExtVal x594 =
        (((x593 * (x587 * x590)) - (x588 * x590)) -
         ((x582 *
           LOAD(LAYOUT_LOOKUP(
                    LAYOUT_SUBSCRIPT(
                        LAYOUT_LOOKUP(arg0, instResult.arm3._arguments_Mul0MulOutput.argU8), 7),
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x607 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 9), 0) -
                   LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 8), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:180
    ExtVal x608 =
        (((x607 * (x601 * x604)) - (x602 * x604)) -
         ((x596 *
           LOAD(LAYOUT_LOOKUP(
                    LAYOUT_SUBSCRIPT(
                        LAYOUT_LOOKUP(arg0, instResult.arm3._arguments_Mul0MulOutput.argU8), 10),
    ...
    ExtVal x611 =
        (LOAD(LAYOUT_LOOKUP(
         ...
         inv_0(x610));
    // zirgen/dsl/passes/GenerateAccum.cpp:146
    ExtVal x612 = (LOAD_EXT(LAYOUT_LOOKUP(x3, randomness.memoryArg.addr), 0) *
                   LOAD(LAYOUT_LOOKUP(arg0, instResult.arm3._0._0.io.oldTxn.addr._super), 0));
    ExtVal x613 = (LOAD_EXT(LAYOUT_LOOKUP(x3, randomness.memoryArg.cycle), 0) *
                   LOAD(LAYOUT_LOOKUP(arg0, instResult.arm3._0._0.io.oldTxn.cycle._super), 0));
    ExtVal x614 = (LOAD_EXT(LAYOUT_LOOKUP(x3, randomness.memoryArg.dataLow), 0) *
                   LOAD(LAYOUT_LOOKUP(arg0, instResult.arm3._0._0.io.oldTxn.dataLow._super), 0));
    ExtVal x615 = (LOAD_EXT(LAYOUT_LOOKUP(x3, randomness.memoryArg.dataHigh), 0) *
                   LOAD(LAYOUT_LOOKUP(arg0, instResult.arm3._0._0.io.oldTxn.dataHigh._super), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:157
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:240
    ExtVal x618 =
        (LOAD(LAYOUT_LOOKUP(arg0, instResult.arm3._0._0.io.oldTxn.count._super), 0) * inv_0(x617));
    // zirgen/dsl/passes/GenerateAccum.cpp:217
    ...
    ExtVal x620 =
        (LOAD(LAYOUT_LOOKUP(
         ...
         x617);
    // zirgen/dsl/passes/GenerateAccum.cpp:146
    ExtVal x621 = (LOAD_EXT(LAYOUT_LOOKUP(x3, randomness.memoryArg.addr), 0) *
                   LOAD(LAYOUT_LOOKUP(arg0, instResult.arm3._0._0.io.newTxn.addr._super), 0));
    ExtVal x622 = (LOAD_EXT(LAYOUT_LOOKUP(x3, randomness.memoryArg.cycle), 0) *
                   LOAD(LAYOUT_LOOKUP(arg0, instResult.arm3._0._0.io.newTxn.cycle._super), 0));
    ExtVal x623 = (LOAD_EXT(LAYOUT_LOOKUP(x3, randomness.memoryArg.dataLow), 0) *
                   LOAD(LAYOUT_LOOKUP(arg0, instResult.arm3._0._0.io.newTxn.dataLow._super), 0));
    ExtVal x624 = (LOAD_EXT(LAYOUT_LOOKUP(x3, randomness.memoryArg.dataHigh), 0) *
                   LOAD(LAYOUT_LOOKUP(arg0, instResult.arm3._0._0.io.newTxn.dataHigh._super), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:157
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:240
    ExtVal x627 =
        (LOAD(LAYOUT_LOOKUP(arg0, instResult.arm3._0._0.io.newTxn.count._super), 0) * inv_0(x626));
    // zirgen/dsl/passes/GenerateAccum.cpp:241
    ExtVal x628 = (((x606 + x611) + x618) + x627);
    // zirgen/dsl/passes/GenerateAccum.cpp:189
    STORE_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 10), x628);
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x629 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 10), 0) -
                   LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 9), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:180
    ExtVal x630 =
        (((x629 * (x619 * x626)) - (x620 * x626)) -
         ((x610 * LOAD(LAYOUT_LOOKUP(arg0, instResult.arm3._0._0.io.oldTxn.count._super), 0)) *
          x626));
    // zirgen/dsl/passes/GenerateAccum.cpp:182
    EQZ((x630 -
         (x619 * LOAD(LAYOUT_LOOKUP(arg0, instResult.arm3._0._0.io.newTxn.count._super), 0))),
        "zirgen/dsl/passes/GenerateAccum.cpp:182");
    // zirgen/dsl/passes/GenerateAccum.cpp:146
    ExtVal x631 = (LOAD_EXT(LAYOUT_LOOKUP(x3, randomness.cycleArg.cycle), 0) *
                   LOAD(LAYOUT_LOOKUP(arg0, instResult.arm3._0._0._0._0.arg.cycle._super), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:238
    ExtVal x632 = (x631 + LOAD_EXT(LAYOUT_LOOKUP(x3, randomness._offset), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:240
    ExtVal x633 =
        (LOAD(LAYOUT_LOOKUP(arg0, instResult.arm3._0._0._0._0.arg.count._super), 0) * inv_0(x632));
    // zirgen/dsl/passes/GenerateAccum.cpp:146
    ExtVal x634 = (LOAD_EXT(LAYOUT_LOOKUP(x3, randomness.argU16.val), 0) *
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:240
    ExtVal x636 =
        (LOAD(LAYOUT_LOOKUP(arg0, instResult.arm3.pcAdd.low16.arg.count._super), 0) * inv_0(x635));
    // zirgen/dsl/passes/GenerateAccum.cpp:217
    ExtVal x637 = (x632 * x635);
    // zirgen/dsl/passes/GenerateAccum.cpp:223
    ExtVal x638 =
        (LOAD(LAYOUT_LOOKUP(arg0, instResult.arm3._0._0._0._0.arg.count._super), 0) * x635);
    // zirgen/dsl/passes/GenerateAccum.cpp:146
    ExtVal x639 = (LOAD_EXT(LAYOUT_LOOKUP(x3, randomness.argU16.val), 0) *
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:240
    ExtVal x641 =
        (LOAD(LAYOUT_LOOKUP(arg0, instResult.arm3.pcAdd.high16.arg.count._super), 0) * inv_0(x640));
    // zirgen/dsl/passes/GenerateAccum.cpp:241
    ExtVal x642 = (((x628 + x633) + x636) + x641);
    // zirgen/dsl/passes/GenerateAccum.cpp:189
    STORE_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 11), x642);
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x643 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 11), 0) -
                   LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 10), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:180
    ExtVal x644 =
        (((x643 * (x637 * x640)) - (x638 * x640)) -
         ((x632 * LOAD(LAYOUT_LOOKUP(arg0, instResult.arm3.pcAdd.low16.arg.count._super), 0)) *
          x640));
    // zirgen/dsl/passes/GenerateAccum.cpp:182
    EQZ((x644 -
         (x637 * LOAD(LAYOUT_LOOKUP(arg0, instResult.arm3.pcAdd.high16.arg.count._super), 0))),
        "zirgen/dsl/passes/GenerateAccum.cpp:182");
    // zirgen/dsl/passes/GenerateAccum.cpp:122
    STORE_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 18), x642);
    // zirgen/dsl/passes/GenerateAccum.cpp:124
    ExtVal x645 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 18), 0) -
    ...
    x5 = x4;
                 ...
                 LOAD(LAYOUT_LOOKUP(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(arg0, instResult._selector), 4),
                      ...
                      0))) {
    // zirgen/dsl/passes/GenerateAccum.cpp:146
    ExtVal x646 = (LOAD_EXT(LAYOUT_LOOKUP(x3, randomness.cycleArg.cycle), 0) *
                   LOAD(LAYOUT_LOOKUP(arg0, instResult.arm4.input.decoded.arg.cycle._super), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:238
    ExtVal x647 = (x646 + LOAD_EXT(LAYOUT_LOOKUP(x3, randomness._offset), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:240
    ExtVal x648 = (LOAD(LAYOUT_LOOKUP(arg0, instResult.arm4.input.decoded.arg.count._super), 0) *
                   inv_0(x647));
    // zirgen/dsl/passes/GenerateAccum.cpp:241
    ...
    ExtVal x650 =
        (LOAD_EXT(LAYOUT_LOOKUP(x3, randomness.argU16.val), 0) *
         LOAD(
             LAYOUT_LOOKUP(arg0, instResult.arm4.input.decoded.pcAddr.upperDiff.ret.arg.val._super),
             0));
    // zirgen/dsl/passes/GenerateAccum.cpp:238
    ...
    ExtVal x652 =
        (LOAD(LAYOUT_LOOKUP(arg0,
                            instResult.arm4.input.decoded.pcAddr.upperDiff.ret.arg.count._super),
              0) *
         inv_0(x651));
    // zirgen/dsl/passes/GenerateAccum.cpp:217
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:223
    ExtVal x654 =
        (LOAD(LAYOUT_LOOKUP(arg0, instResult.arm4.input.decoded.arg.count._super), 0) * x651);
    // zirgen/dsl/passes/GenerateAccum.cpp:146
    ExtVal x655 =
        (LOAD_EXT(LAYOUT_LOOKUP(x3, randomness.argU16.val), 0) *
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x659 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 0), 0) -
                   LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 18), 1));
    // zirgen/dsl/passes/GenerateAccum.cpp:180
    ExtVal x660 =
        (((x659 * (x653 * x656)) - (x654 * x656)) -
         ((x647 *
           LOAD(LAYOUT_LOOKUP(arg0,
                              instResult.arm4.input.decoded.pcAddr.upperDiff.ret.arg.count._super),
                0)) *
          x656));
    // zirgen/dsl/passes/GenerateAccum.cpp:182
    EQZ((x660 - (x653 * LOAD(LAYOUT_LOOKUP(
                                 arg0, instResult.arm4.input.decoded.pcAddr.med14.arg.count._super),
                             0))),
        "zirgen/dsl/passes/GenerateAccum.cpp:182");
    // zirgen/dsl/passes/GenerateAccum.cpp:146
    ExtVal x661 =
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x681 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 1), 0) -
                   LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 0), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:180
    ExtVal x682 =
        (((x681 * (x675 * x678)) - (x676 * x678)) -
         ((x666 *
           LOAD(LAYOUT_LOOKUP(arg0, instResult.arm4.input.decoded.loadInst.io.newTxn.count._super),
                0)) *
          x678));
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x703 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 2), 0) -
                   LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 1), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:180
    ExtVal x704 =
        (((x703 * (x697 * x700)) - (x698 * x700)) -
         ((x688 *
           LOAD(LAYOUT_LOOKUP(arg0, instResult.arm4.input.rs1._super.io.newTxn.count._super), 0)) *
          x700));
    // zirgen/dsl/passes/GenerateAccum.cpp:182
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x725 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 3), 0) -
                   LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 2), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:180
    ExtVal x726 =
        (((x725 * (x719 * x722)) - (x720 * x722)) -
         ((x710 *
           LOAD(LAYOUT_LOOKUP(arg0, instResult.arm4.input.rs2._super.io.newTxn.count._super), 0)) *
          x722));
    // zirgen/dsl/passes/GenerateAccum.cpp:182
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x739 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 4), 0) -
                   LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 3), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:180
    ExtVal x740 =
        (((x739 * (x733 * x736)) - (x734 * x736)) -
         ((x728 *
           LOAD(LAYOUT_LOOKUP(
                    LAYOUT_SUBSCRIPT(
                        LAYOUT_LOOKUP(arg0, instResult.arm4._arguments_Div0MulOutput.argU16), 1),
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x753 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 5), 0) -
                   LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 4), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:180
    ExtVal x754 =
        (((x753 * (x747 * x750)) - (x748 * x750)) -
         ((x742 *
           LOAD(LAYOUT_LOOKUP(
                    LAYOUT_SUBSCRIPT(
                        LAYOUT_LOOKUP(arg0, instResult.arm4._arguments_Div0MulOutput.argU16), 4),
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x767 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 6), 0) -
                   LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 5), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:180
    ExtVal x768 =
        (((x767 * (x761 * x764)) - (x762 * x764)) -
         ((x756 *
           LOAD(LAYOUT_LOOKUP(
                    LAYOUT_SUBSCRIPT(
                        LAYOUT_LOOKUP(arg0, instResult.arm4._arguments_Div0MulOutput.argU16), 7),
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x781 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 7), 0) -
                   LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 6), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:180
    ExtVal x782 =
        (((x781 * (x775 * x778)) - (x776 * x778)) -
         ((x770 *
           LOAD(LAYOUT_LOOKUP(
                    LAYOUT_SUBSCRIPT(
                        LAYOUT_LOOKUP(arg0, instResult.arm4._arguments_Div0MulOutput.argU8), 1),
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x795 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 8), 0) -
                   LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 7), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:180
    ExtVal x796 =
        (((x795 * (x789 * x792)) - (x790 * x792)) -
         ((x784 *
           LOAD(LAYOUT_LOOKUP(
                    LAYOUT_SUBSCRIPT(
                        LAYOUT_LOOKUP(arg0, instResult.arm4._arguments_Div0MulOutput.argU8), 4),
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x809 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 9), 0) -
                   LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 8), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:180
    ExtVal x810 =
        (((x809 * (x803 * x806)) - (x804 * x806)) -
         ((x798 *
           LOAD(LAYOUT_LOOKUP(
                    LAYOUT_SUBSCRIPT(
                        LAYOUT_LOOKUP(arg0, instResult.arm4._arguments_Div0MulOutput.argU8), 7),
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x823 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 10), 0) -
                   LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 9), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:180
    ExtVal x824 =
        (((x823 * (x817 * x820)) - (x818 * x820)) -
         ((x812 *
           LOAD(LAYOUT_LOOKUP(
                    LAYOUT_SUBSCRIPT(
                        LAYOUT_LOOKUP(arg0, instResult.arm4._arguments_Div0MulOutput.argU8), 10),
    ...
    ExtVal x827 =
        (LOAD(LAYOUT_LOOKUP(
         ...
         inv_0(x826));
    // zirgen/dsl/passes/GenerateAccum.cpp:146
    ExtVal x828 = (LOAD_EXT(LAYOUT_LOOKUP(x3, randomness.memoryArg.addr), 0) *
                   LOAD(LAYOUT_LOOKUP(arg0, instResult.arm4._0._0.io.oldTxn.addr._super), 0));
    ExtVal x829 = (LOAD_EXT(LAYOUT_LOOKUP(x3, randomness.memoryArg.cycle), 0) *
                   LOAD(LAYOUT_LOOKUP(arg0, instResult.arm4._0._0.io.oldTxn.cycle._super), 0));
    ExtVal x830 = (LOAD_EXT(LAYOUT_LOOKUP(x3, randomness.memoryArg.dataLow), 0) *
                   LOAD(LAYOUT_LOOKUP(arg0, instResult.arm4._0._0.io.oldTxn.dataLow._super), 0));
    ExtVal x831 = (LOAD_EXT(LAYOUT_LOOKUP(x3, randomness.memoryArg.dataHigh), 0) *
                   LOAD(LAYOUT_LOOKUP(arg0, instResult.arm4._0._0.io.oldTxn.dataHigh._super), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:157
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:240
    ExtVal x834 =
        (LOAD(LAYOUT_LOOKUP(arg0, instResult.arm4._0._0.io.oldTxn.count._super), 0) * inv_0(x833));
    // zirgen/dsl/passes/GenerateAccum.cpp:217
    ...
    ExtVal x836 =
        (LOAD(LAYOUT_LOOKUP(
         ...
         x833);
    // zirgen/dsl/passes/GenerateAccum.cpp:146
    ExtVal x837 = (LOAD_EXT(LAYOUT_LOOKUP(x3, randomness.memoryArg.addr), 0) *
                   LOAD(LAYOUT_LOOKUP(arg0, instResult.arm4._0._0.io.newTxn.addr._super), 0));
    ExtVal x838 = (LOAD_EXT(LAYOUT_LOOKUP(x3, randomness.memoryArg.cycle), 0) *
                   LOAD(LAYOUT_LOOKUP(arg0, instResult.arm4._0._0.io.newTxn.cycle._super), 0));
    ExtVal x839 = (LOAD_EXT(LAYOUT_LOOKUP(x3, randomness.memoryArg.dataLow), 0) *
                   LOAD(LAYOUT_LOOKUP(arg0, instResult.arm4._0._0.io.newTxn.dataLow._super), 0));
    ExtVal x840 = (LOAD_EXT(LAYOUT_LOOKUP(x3, randomness.memoryArg.dataHigh), 0) *
                   LOAD(LAYOUT_LOOKUP(arg0, instResult.arm4._0._0.io.newTxn.dataHigh._super), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:157
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:240
    ExtVal x843 =
        (LOAD(LAYOUT_LOOKUP(arg0, instResult.arm4._0._0.io.newTxn.count._super), 0) * inv_0(x842));
    // zirgen/dsl/passes/GenerateAccum.cpp:241
    ExtVal x844 = (((x822 + x827) + x834) + x843);
    // zirgen/dsl/passes/GenerateAccum.cpp:189
    STORE_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 11), x844);
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x845 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 11), 0) -
                   LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 10), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:180
    ExtVal x846 =
        (((x845 * (x835 * x842)) - (x836 * x842)) -
         ((x826 * LOAD(LAYOUT_LOOKUP(arg0, instResult.arm4._0._0.io.oldTxn.count._super), 0)) *
          x842));
    // zirgen/dsl/passes/GenerateAccum.cpp:182
    EQZ((x846 -
         (x835 * LOAD(LAYOUT_LOOKUP(arg0, instResult.arm4._0._0.io.newTxn.count._super), 0))),
        "zirgen/dsl/passes/GenerateAccum.cpp:182");
    // zirgen/dsl/passes/GenerateAccum.cpp:146
    ExtVal x847 = (LOAD_EXT(LAYOUT_LOOKUP(x3, randomness.cycleArg.cycle), 0) *
                   LOAD(LAYOUT_LOOKUP(arg0, instResult.arm4._0._0._0._0.arg.cycle._super), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:238
    ExtVal x848 = (x847 + LOAD_EXT(LAYOUT_LOOKUP(x3, randomness._offset), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:240
    ExtVal x849 =
        (LOAD(LAYOUT_LOOKUP(arg0, instResult.arm4._0._0._0._0.arg.count._super), 0) * inv_0(x848));
    // zirgen/dsl/passes/GenerateAccum.cpp:146
    ExtVal x850 = (LOAD_EXT(LAYOUT_LOOKUP(x3, randomness.argU16.val), 0) *
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:240
    ExtVal x852 =
        (LOAD(LAYOUT_LOOKUP(arg0, instResult.arm4.pcAdd.low16.arg.count._super), 0) * inv_0(x851));
    // zirgen/dsl/passes/GenerateAccum.cpp:217
    ExtVal x853 = (x848 * x851);
    // zirgen/dsl/passes/GenerateAccum.cpp:223
    ExtVal x854 =
        (LOAD(LAYOUT_LOOKUP(arg0, instResult.arm4._0._0._0._0.arg.count._super), 0) * x851);
    // zirgen/dsl/passes/GenerateAccum.cpp:146
    ExtVal x855 = (LOAD_EXT(LAYOUT_LOOKUP(x3, randomness.argU16.val), 0) *
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:240
    ExtVal x857 =
        (LOAD(LAYOUT_LOOKUP(arg0, instResult.arm4.pcAdd.high16.arg.count._super), 0) * inv_0(x856));
    // zirgen/dsl/passes/GenerateAccum.cpp:241
    ExtVal x858 = (((x844 + x849) + x852) + x857);
    // zirgen/dsl/passes/GenerateAccum.cpp:189
    STORE_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 12), x858);
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x859 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 12), 0) -
                   LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 11), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:180
    ExtVal x860 =
        (((x859 * (x853 * x856)) - (x854 * x856)) -
         ((x848 * LOAD(LAYOUT_LOOKUP(arg0, instResult.arm4.pcAdd.low16.arg.count._super), 0)) *
          x856));
    // zirgen/dsl/passes/GenerateAccum.cpp:182
    EQZ((x860 -
         (x853 * LOAD(LAYOUT_LOOKUP(arg0, instResult.arm4.pcAdd.high16.arg.count._super), 0))),
        "zirgen/dsl/passes/GenerateAccum.cpp:182");
    // zirgen/dsl/passes/GenerateAccum.cpp:122
    STORE_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 18), x858);
    // zirgen/dsl/passes/GenerateAccum.cpp:124
    ExtVal x861 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 18), 0) -
    ...
    x5 = x4;
                 ...
                 LOAD(LAYOUT_LOOKUP(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(arg0, instResult._selector), 5),
                      ...
                      0))) {
    // zirgen/dsl/passes/GenerateAccum.cpp:146
    ExtVal x862 = (LOAD_EXT(LAYOUT_LOOKUP(x3, randomness.cycleArg.cycle), 0) *
                   LOAD(LAYOUT_LOOKUP(arg0, instResult.arm5.input.decoded.arg.cycle._super), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:238
    ExtVal x863 = (x862 + LOAD_EXT(LAYOUT_LOOKUP(x3, randomness._offset), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:240
    ExtVal x864 = (LOAD(LAYOUT_LOOKUP(arg0, instResult.arm5.input.decoded.arg.count._super), 0) *
                   inv_0(x863));
    // zirgen/dsl/passes/GenerateAccum.cpp:241
    ...
    ExtVal x866 =
        (LOAD_EXT(LAYOUT_LOOKUP(x3, randomness.argU16.val), 0) *
         LOAD(
             LAYOUT_LOOKUP(arg0, instResult.arm5.input.decoded.pcAddr.upperDiff.ret.arg.val._super),
             0));
    // zirgen/dsl/passes/GenerateAccum.cpp:238
    ...
    ExtVal x868 =
        (LOAD(LAYOUT_LOOKUP(arg0,
                            instResult.arm5.input.decoded.pcAddr.upperDiff.ret.arg.count._super),
              0) *
         inv_0(x867));
    // zirgen/dsl/passes/GenerateAccum.cpp:217
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:223
    ExtVal x870 =
        (LOAD(LAYOUT_LOOKUP(arg0, instResult.arm5.input.decoded.arg.count._super), 0) * x867);
    // zirgen/dsl/passes/GenerateAccum.cpp:146
    ExtVal x871 =
        (LOAD_EXT(LAYOUT_LOOKUP(x3, randomness.argU16.val), 0) *
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x875 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 0), 0) -
                   LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 18), 1));
    // zirgen/dsl/passes/GenerateAccum.cpp:180
    ExtVal x876 =
        (((x875 * (x869 * x872)) - (x870 * x872)) -
         ((x863 *
           LOAD(LAYOUT_LOOKUP(arg0,
                              instResult.arm5.input.decoded.pcAddr.upperDiff.ret.arg.count._super),
                0)) *
          x872));
    // zirgen/dsl/passes/GenerateAccum.cpp:182
    EQZ((x876 - (x869 * LOAD(LAYOUT_LOOKUP(
                                 arg0, instResult.arm5.input.decoded.pcAddr.med14.arg.count._super),
                             0))),
        "zirgen/dsl/passes/GenerateAccum.cpp:182");
    // zirgen/dsl/passes/GenerateAccum.cpp:146
    ExtVal x877 =
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x897 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 1), 0) -
                   LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 0), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:180
    ExtVal x898 =
        (((x897 * (x891 * x894)) - (x892 * x894)) -
         ((x882 *
           LOAD(LAYOUT_LOOKUP(arg0, instResult.arm5.input.decoded.loadInst.io.newTxn.count._super),
                0)) *
          x894));
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x919 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 2), 0) -
                   LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 1), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:180
    ExtVal x920 =
        (((x919 * (x913 * x916)) - (x914 * x916)) -
         ((x904 *
           LOAD(LAYOUT_LOOKUP(arg0, instResult.arm5.input.rs1._super.io.newTxn.count._super), 0)) *
          x916));
    // zirgen/dsl/passes/GenerateAccum.cpp:182
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:223
    ExtVal x928 =
        (LOAD(LAYOUT_LOOKUP(arg0, instResult.arm5.input.addrU32.low16.arg.count._super), 0) * x925);
    // zirgen/dsl/passes/GenerateAccum.cpp:146
    ExtVal x929 =
        (LOAD_EXT(LAYOUT_LOOKUP(x3, randomness.argU16.val), 0) *
         LOAD(LAYOUT_LOOKUP(arg0, instResult.arm5.input.addr.upperDiff.ret.arg.val._super), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:238
    ExtVal x930 = (x929 + LOAD_EXT(LAYOUT_LOOKUP(x3, randomness._offset), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:240
    ExtVal x931 =
        (LOAD(LAYOUT_LOOKUP(arg0, instResult.arm5.input.addr.upperDiff.ret.arg.count._super), 0) *
         inv_0(x930));
    // zirgen/dsl/passes/GenerateAccum.cpp:241
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x933 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 3), 0) -
                   LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 2), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:180
    ExtVal x934 =
        (((x933 * (x927 * x930)) - (x928 * x930)) -
         ((x922 *
           LOAD(LAYOUT_LOOKUP(arg0, instResult.arm5.input.addrU32.high16.arg.count._super), 0)) *
          x930));
    // zirgen/dsl/passes/GenerateAccum.cpp:182
    EQZ((x934 -
        ...
        "zirgen/dsl/passes/GenerateAccum.cpp:182");
    // zirgen/dsl/passes/GenerateAccum.cpp:146
    ExtVal x935 = (LOAD_EXT(LAYOUT_LOOKUP(x3, randomness.argU16.val), 0) *
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:240
    ExtVal x937 = (LOAD(LAYOUT_LOOKUP(arg0, instResult.arm5.input.addr.med14.arg.count._super), 0) *
                   inv_0(x936));
    // zirgen/dsl/passes/GenerateAccum.cpp:146
    ExtVal x938 = (LOAD_EXT(LAYOUT_LOOKUP(x3, randomness.memoryArg.addr), 0) *
                   LOAD(LAYOUT_LOOKUP(arg0, instResult.arm5.input.data.io.oldTxn.addr._super), 0));
    ExtVal x939 = (LOAD_EXT(LAYOUT_LOOKUP(x3, randomness.memoryArg.cycle), 0) *
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:240
    ExtVal x944 = (LOAD(LAYOUT_LOOKUP(arg0, instResult.arm5.input.data.io.oldTxn.count._super), 0) *
                   inv_0(x943));
    // zirgen/dsl/passes/GenerateAccum.cpp:217
    ExtVal x945 = (x936 * x943);
    // zirgen/dsl/passes/GenerateAccum.cpp:223
    ExtVal x946 =
        (LOAD(LAYOUT_LOOKUP(arg0, instResult.arm5.input.addr.med14.arg.count._super), 0) * x943);
    // zirgen/dsl/passes/GenerateAccum.cpp:146
    ExtVal x947 = (LOAD_EXT(LAYOUT_LOOKUP(x3, randomness.memoryArg.addr), 0) *
                   LOAD(LAYOUT_LOOKUP(arg0, instResult.arm5.input.data.io.newTxn.addr._super), 0));
    ExtVal x948 = (LOAD_EXT(LAYOUT_LOOKUP(x3, randomness.memoryArg.cycle), 0) *
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:240
    ExtVal x953 = (LOAD(LAYOUT_LOOKUP(arg0, instResult.arm5.input.data.io.newTxn.count._super), 0) *
                   inv_0(x952));
    // zirgen/dsl/passes/GenerateAccum.cpp:241
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x955 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 4), 0) -
                   LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 3), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:180
    ExtVal x956 =
        (((x955 * (x945 * x952)) - (x946 * x952)) -
         ((x936 * LOAD(LAYOUT_LOOKUP(arg0, instResult.arm5.input.data.io.oldTxn.count._super), 0)) *
          x952));
    // zirgen/dsl/passes/GenerateAccum.cpp:182
    EQZ((x956 -
         (x945 * LOAD(LAYOUT_LOOKUP(arg0, instResult.arm5.input.data.io.newTxn.count._super), 0))),
        "zirgen/dsl/passes/GenerateAccum.cpp:182");
    // zirgen/dsl/passes/GenerateAccum.cpp:146
    ExtVal x957 = (LOAD_EXT(LAYOUT_LOOKUP(x3, randomness.cycleArg.cycle), 0) *
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:240
    ExtVal x959 = (LOAD(LAYOUT_LOOKUP(arg0, instResult.arm5.input.data._0._0.arg.count._super), 0) *
                   inv_0(x958));
    // zirgen/dsl/passes/GenerateAccum.cpp:146
    ExtVal x960 =
        (LOAD_EXT(LAYOUT_LOOKUP(x3, randomness.argU8.val), 0) *
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:223
    ExtVal x964 =
        (LOAD(LAYOUT_LOOKUP(arg0, instResult.arm5.input.data._0._0.arg.count._super), 0) * x961);
    // zirgen/dsl/passes/GenerateAccum.cpp:146
    ExtVal x965 =
        (LOAD_EXT(LAYOUT_LOOKUP(x3, randomness.argU8.val), 0) *
         LOAD(
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x969 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 5), 0) -
                   LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 4), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:180
    ExtVal x970 =
        (((x969 * (x963 * x966)) - (x964 * x966)) -
         ((x958 * LOAD(LAYOUT_LOOKUP(
                           LAYOUT_SUBSCRIPT(
                               LAYOUT_LOOKUP(arg0, instResult.arm5._arguments_Mem0Output.argU8), 0),
                           count._super),
                       0)) *
    ...
    // zirgen/dsl/passes/GenerateAccum.cpp:177
    ExtVal x1005 = (LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 7), 0) -
                    LOAD_EXT(LAYOUT_SUBSCRIPT(LAYOUT_LOOKUP(layout1, columns), 6), 0));
    // zirgen/dsl/passes/GenerateAccum.cpp:180
    ExtVal x1006 =
